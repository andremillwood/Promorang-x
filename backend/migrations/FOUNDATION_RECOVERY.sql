...
-- =============================================
-- 'FOUNDATION-FIRST' INFRASTRUCTURE RECOVERY
...
-- 2. RESTORE CORE TABLES
-- If they are missing, create them; if they exist, ensure their structure.
...
DO $$ BEGIN
    RAISE NOTICE 'Foundation-First Recovery Complete. Dashboard infrastructure confirmed stable.';
END $$;
