...
const EMAIL_TRANSLATIONS = {
  en: {
    ...
    aftrHrsPass: {
      ...
      lead: 'Your door pass is the AftrHrs QR — not the Promorang membership card. Open it below, or from the top of your wallet.',
  ...
  'es-419': {
    ...
    aftrHrsPass: {
      ...
      lead: 'Tu pase de puerta es el QR de AftrHrs, no la tarjeta de membresía de Promorang. Ábrelo abajo o en la parte de arriba de tu wallet.',
  ...
  'pt-BR': {
    ...
    aftrHrsPass: {
      ...
      lead: 'Seu passe da porta é o QR da AftrHrs — não o cartão de membro Promorang. Abra abaixo ou no topo da sua wallet.',
