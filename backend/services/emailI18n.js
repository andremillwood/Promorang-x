...
const EMAIL_TRANSLATIONS = {
  en: {
    ...
    aftrHrsPass: {
      subject: 'Your AftrHrs pass is ready for this Friday at Sea Deck',
      title: 'Your AftrHrs pass is ready',
      preheader: 'Your AftrHrs Digital Free Pass is ready for this Friday.',
      greeting: 'Hi {{name}},',
      cadence: 'Every Friday · 10:00 PM until · Sea Deck',
      lead: 'Your door pass is the AftrHrs QR — not the Promorang membership card. This pass is for this Friday only. Unused passes expire after the night. Open it below, or from the top of your wallet.',
    ...
    aftrHrsGuestPass: {
      subject: 'Your AftrHrs digital pass — month invite for Sea Deck',
      title: 'Your month invite is ready',
      preheader: 'Your AftrHrs digital pass works like a physical invite for the month.',
      greeting: 'Hi {{name}},',
      cadence: 'Every Friday · 10:00 PM until · Sea Deck',
      lead: 'This digital pass is your door invite for the month. No Promorang account. Open the ticket below and show the code at Sea Deck.',
      passLabel: 'Digital pass',
      showCode: 'Show this code or the ticket QR at the door.',
      freeEntry: 'Free entry for the month',
      arrive: 'Arrive before 11:30 PM to get in free.',
      venue: 'Every Friday from 10:00 PM at Sea Deck, Orchid Village, 20 Barbican Road, Kingston.',
      origin: 'Origin: Alric & Boyd · Afro House, Classic House, House Fusion.',
      ctaText: 'Open my ticket',
      signInNote: 'No Promorang account is required.',
      viewAftrHrs: 'View AftrHrs',
      powered: 'Powered by PROMORANG'
    },
    aftrHrsRsvp: {
      ...
      greeting: 'Hi {{name}},',
      cadence: 'Every Friday · 10:00 PM until · Sea Deck',
      lead: 'You are on this Friday’s list. Give your name at the door — no Promorang account needed. Free entry is before 11:30 PM.',
      passLabel: 'Digital Free Pass',
      showCode: 'Show this code or the QR from your pass at the door.',
      freeEntry: 'Free entry',
      arrive: 'Arrive before 11:30 PM to get in free.',
  ...
  'es-419': {
    ...
    aftrHrsPass: {
      ...
      lead: 'Tu pase de puerta es el QR de AftrHrs, no la tarjeta de membresía de Promorang. Este pase es solo para este viernes. Los pases sin usar vencen después de la noche. Ábrelo abajo o en la parte de arriba de tu wallet.',
    ...
    aftrHrsGuestPass: {
      subject: 'Tu pase digital de AftrHrs — invitación del mes para Sea Deck',
      title: 'Tu invitación del mes ya está lista',
      preheader: 'Tu pase digital de AftrHrs funciona como una invitación física durante el mes.',
      greeting: 'Hola {{name}},',
      cadence: 'Todos los viernes · 10:00 PM hasta · Sea Deck',
      lead: 'Este pase digital es tu invitación de puerta para el mes. Sin cuenta de Promorang. Abre el ticket y muestra el código en Sea Deck.',
      passLabel: 'Pase digital',
      showCode: 'Muestra este código o el QR del ticket en la puerta.',
      freeEntry: 'Entrada gratis del mes',
      arrive: 'Llega antes de las 11:30 PM para entrar gratis.',
      venue: 'Todos los viernes desde las 10:00 PM en Sea Deck, Orchid Village, 20 Barbican Road, Kingston.',
      origin: 'Origin: Alric & Boyd · Afro House, Classic House, House Fusion.',
      ctaText: 'Abrir mi ticket',
      signInNote: 'No necesitas una cuenta de Promorang.',
      viewAftrHrs: 'Ver AftrHrs',
      powered: 'Con el poder de PROMORANG'
    },
    aftrHrsRsvp: {
      ...
      greeting: 'Hola {{name}},',
      cadence: 'Todos los viernes · 10:00 PM hasta · Sea Deck',
      lead: 'Estás en la lista de este viernes. Di tu nombre en la puerta — no necesitas cuenta de Promorang. La entrada gratis es antes de las 11:30 PM.',
      passLabel: 'Pase Digital Gratis',
      showCode: 'Muestra este código o el QR de tu pase en la puerta.',
      freeEntry: 'Entrada gratis',
      arrive: 'Llega antes de las 11:30 PM para entrar gratis.',
  ...
  'pt-BR': {
    ...
    aftrHrsPass: {
      ...
      lead: 'Seu passe da porta é o QR da AftrHrs — não o cartão de membro Promorang. Este passe é só para esta sexta. Passes sem uso expiram depois da noite. Abra abaixo ou no topo da sua wallet.',
    ...
    aftrHrsGuestPass: {
      subject: 'Seu passe digital da AftrHrs — convite do mês para o Sea Deck',
      title: 'Seu convite do mês está pronto',
      preheader: 'Seu passe digital da AftrHrs funciona como um convite físico durante o mês.',
      greeting: 'Olá {{name}},',
      cadence: 'Toda sexta · 22:00 até · Sea Deck',
      lead: 'Este passe digital é o seu convite da porta para o mês. Sem conta Promorang. Abra o ticket e mostre o código no Sea Deck.',
      passLabel: 'Passe digital',
      showCode: 'Mostre este código ou o QR do ticket na porta.',
      freeEntry: 'Entrada grátis do mês',
      arrive: 'Chegue antes das 23:30 para entrar de graça.',
      venue: 'Toda sexta a partir das 22:00 no Sea Deck, Orchid Village, 20 Barbican Road, Kingston.',
      origin: 'Origin: Alric & Boyd · Afro House, Classic House, House Fusion.',
      ctaText: 'Abrir meu ticket',
      signInNote: 'Não precisa de conta Promorang.',
      viewAftrHrs: 'Ver AftrHrs',
      powered: 'Com o poder da PROMORANG'
    },
    aftrHrsRsvp: {
      ...
      greeting: 'Olá {{name}},',
      cadence: 'Toda sexta · 22:00 até · Sea Deck',
      lead: 'Você está na lista desta sexta. Diga seu nome na porta — sem conta Promorang. A entrada grátis é antes das 23:30.',
      passLabel: 'Passe Digital Grátis',
      showCode: 'Mostre este código ou o QR do seu passe na porta.',
      freeEntry: 'Entrada grátis',
      arrive: 'Chegue antes das 23:30 para entrar de graça.',
