...
const EMAIL_TRANSLATIONS = {
  en: {
    ...
    hostCreateMoment: {
      ...
      greeting: 'Hi {{name}},',
      intro: 'You signed up {{days}} days ago as a Host, but have not created your first <strong>Moment</strong> yet.',
      chanceCopy: 'Moments are your chance to:',
      feature1: 'Share exclusive content with your community',
      feature2: 'Build deeper engagement with followers',
      feature3: 'Monetize your most valuable experiences',
      feature4: 'Grow your influence on the platform',
      startLabel: 'Getting started',
      startValue: 'Takes 5 minutes',
      startSublabel: 'Upload a photo, video, or link and set your access rules',
    ...
    hostReengagement: {
      ...
      greeting: 'Hi {{name}},',
      intro: "It's been <strong>{{days}} days</strong> since your last Moment. Your followers are eager for new content.",
      lastLabel: 'Last Moment',
      lastValue: '{{days}} days ago',
      activityLabel: 'Follower activity',
      activityValue: 'High',
      nextCopy: 'Fresh content keeps your community engaged and growing. What will you share next?',
    ...
    brandSponsor: {
      ...
      greeting: 'Hi {{name}},',
      intro: 'Moment sponsorship is one of the most effective ways to reach engaged communities on Promorang.',
      whyLabel: 'Why sponsor?',
      whyValue: '3x higher engagement',
      whySublabel: 'vs traditional display advertising',
      trendingLabel: 'Trending now',
      trendingCopy: 'These popular Moments are accepting sponsorships:',
      byHost: 'by {{hostName}} • {{engagement}} engagements',
      closeCopy: 'Sponsoring puts your brand message directly into content that people are actively consuming.',
    ...
    contentConsumption: {
      subject: '{{count}} new Moment(s) waiting from creators you follow',
      title: 'Content waiting for you',
      preheader: '{{count}} new Moment(s) from creators you follow.',
      greeting: 'Hi {{name}},',
      intro: 'You have <strong>{{count}} new Moment(s)</strong> waiting from creators you follow.',
      featuredLabel: 'Featured Moment',
      byHost: 'by {{hostName}}',
      missCopy: "Don't miss exclusive content, behind-the-scenes access, and special offers from your favorite creators.",
      ctaText: 'View Moments',
      footerNote: 'Engaging with content increases your chances of unlocking exclusive rewards.'
    },
    lowBudget: {
      subject: 'Campaign "{{campaignName}}" budget at {{percent}}% — add funds',
      title: 'Campaign budget running low',
      preheader: '{{percent}}% of budget remaining for {{campaignName}}',
      greeting: 'Hi {{name}},',
      intro: 'Your campaign <strong>{{campaignName}}</strong> is running low on budget.',
      remainingLabel: 'Remaining budget',
      remainingValue: '{{remaining}} Gems',
      remainingSublabel: '{{percent}}% of {{total}} Gems total',
      campaignLabel: 'Campaign',
      statusLabel: 'Status',
      statusValue: 'Active (low budget)',
      topUpCopy: 'Top up your budget soon to keep your campaign running without interruption.',
      ctaText: 'Add budget',
      footerNote: 'Campaigns with enough budget see 40% more completions.'
    },
    participationInterest: {
      ...
      greeting: 'Hi {{name}},',
      intro: '<strong>{{requesterName}}</strong> wants to participate in your Moment:',
      momentLabel: 'Moment',
      pendingCopy: '{{count}} total requests pending',
      reviewCopy: 'Review and approve participants to grow your engaged community around this content.',
      ctaText: 'Review requests',
      footerNote: "Approving engaged participants increases your Moment's reach and value."
    },
    socialEngagement: {
      subject: '{{actorName}} {{verb}} your content',
      title: 'New engagement',
      preheader: '{{actorName}} {{verb}} your content',
      greeting: 'Hi {{name}},',
      verbComment: 'commented on',
      verbLike: 'liked',
      verbShare: 'shared',
      verbFollow: 'started following',
      yourContent: 'your <strong>{{contentTitle}}</strong>',
      you: 'you',
      andOthers: 'and {{count}} others',
      resonating: 'Your content is resonating with the community. Keep creating to build your influence.',
  ...
  'es-419': {
    ...
    hostCreateMoment: {
      subject: 'Tu comunidad espera — crea tu primer Momento',
      title: 'Crea tu primer Momento',
      preheader: 'Tu comunidad espera contenido.',
      greeting: 'Hola {{name}},',
      intro: 'Te registraste hace {{days}} días como Anfitrión y aún no creaste tu primer <strong>Momento</strong>.',
      chanceCopy: 'Los Momentos son tu chance para:',
      feature1: 'Compartir contenido exclusivo con tu comunidad',
      feature2: 'Construir más interacción con tus seguidores',
      feature3: 'Monetizar tus experiencias más valiosas',
      feature4: 'Hacer crecer tu influencia en la plataforma',
      startLabel: 'Para empezar',
      startValue: 'Toma 5 minutos',
      startSublabel: 'Sube una foto, video o enlace y define las reglas de acceso',
      ctaText: 'Crear mi primer Momento',
      footerNote: 'Los anfitriones que crean en su primera semana ven 3x más interacción de seguidores.'
    },
    hostReengagement: {
      subject: 'Tus seguidores esperan tu próximo Momento',
      title: 'Tus seguidores te extrañan',
      preheader: 'Hace tiempo que no publicas un Momento.',
      greeting: 'Hola {{name}},',
      intro: 'Pasaron <strong>{{days}} días</strong> desde tu último Momento. Tus seguidores quieren contenido nuevo.',
      lastLabel: 'Último Momento',
      lastValue: 'hace {{days}} días',
      activityLabel: 'Actividad de seguidores',
      activityValue: 'Alta',
      nextCopy: 'El contenido fresco mantiene a tu comunidad activa y creciendo. ¿Qué compartirás ahora?',
      ctaText: 'Crear nuevo Momento',
      footerNote: 'Los anfitriones constantes construyen audiencias 5x más grandes con el tiempo.'
    },
    brandSponsor: {
      subject: 'Llega a audiencias activas — patrocina Momentos en tendencia',
      title: 'Patrocina Momentos de alta interacción',
      preheader: 'Pon tu marca frente a audiencias comprometidas.',
      greeting: 'Hola {{name}},',
      intro: 'Patrocinar un Momento es una de las formas más efectivas de llegar a comunidades activas en Promorang.',
      whyLabel: '¿Por qué patrocinar?',
      whyValue: '3x más interacción',
      whySublabel: 'frente a la publicidad display tradicional',
      trendingLabel: 'En tendencia ahora',
      trendingCopy: 'Estos Momentos populares aceptan patrocinios:',
      byHost: 'por {{hostName}} • {{engagement}} interacciones',
      closeCopy: 'El patrocinio pone tu mensaje en contenido que la gente está consumiendo ahora.',
      ctaText: 'Ver oportunidades de patrocinio',
      footerNote: 'Hay cupos limitados por Momento — asegura tu lugar pronto.'
    },
    contentConsumption: {
      subject: '{{count}} Momento(s) nuevo(s) de creadores que sigues',
      title: 'Hay contenido esperándote',
      preheader: '{{count}} Momento(s) nuevo(s) de creadores que sigues.',
      greeting: 'Hola {{name}},',
      intro: 'Tienes <strong>{{count}} Momento(s) nuevo(s)</strong> de creadores que sigues.',
      featuredLabel: 'Momento destacado',
      byHost: 'por {{hostName}}',
      missCopy: 'No te pierdas contenido exclusivo, acceso detrás de cámaras y ofertas de tus creadores favoritos.',
      ctaText: 'Ver Momentos',
      footerNote: 'Interactuar con contenido aumenta tus chances de desbloquear recompensas exclusivas.'
    },
    lowBudget: {
      subject: 'La campaña "{{campaignName}}" está al {{percent}}% del presupuesto — agrega fondos',
      title: 'El presupuesto de la campaña está bajo',
      preheader: 'Queda el {{percent}}% del presupuesto de {{campaignName}}',
      greeting: 'Hola {{name}},',
      intro: 'Tu campaña <strong>{{campaignName}}</strong> se está quedando sin presupuesto.',
      remainingLabel: 'Presupuesto restante',
      remainingValue: '{{remaining}} Gems',
      remainingSublabel: '{{percent}}% de {{total}} Gems en total',
      campaignLabel: 'Campaña',
      statusLabel: 'Estado',
      statusValue: 'Activa (presupuesto bajo)',
      topUpCopy: 'Recarga pronto para que la campaña no se interrumpa.',
      ctaText: 'Agregar presupuesto',
      footerNote: 'Las campañas con presupuesto suficiente ven 40% más de compleciones.'
    },
    participationInterest: {
      subject: '{{requesterName}} quiere unirse a tu Momento "{{momentTitle}}"',
      title: 'Nueva solicitud de participación',
      preheader: '{{requesterName}} quiere unirse a tu Momento',
      greeting: 'Hola {{name}},',
      intro: '<strong>{{requesterName}}</strong> quiere participar en tu Momento:',
      momentLabel: 'Momento',
      pendingCopy: '{{count}} solicitudes pendientes en total',
      reviewCopy: 'Revisa y aprueba participantes para hacer crecer tu comunidad alrededor de este contenido.',
      ctaText: 'Revisar solicitudes',
      footerNote: 'Aprobar participantes comprometidos aumenta el alcance y el valor de tu Momento.'
    },
    socialEngagement: {
      subject: '{{actorName}} {{verb}} tu contenido',
      title: 'Nueva interacción',
      preheader: '{{actorName}} {{verb}} tu contenido',
      greeting: 'Hola {{name}},',
      verbComment: 'comentó',
      verbLike: 'le gustó',
      verbShare: 'compartió',
      verbFollow: 'empezó a seguirte',
      yourContent: 'tu <strong>{{contentTitle}}</strong>',
      you: 'a ti',
      andOthers: 'y {{count}} más',
      resonating: 'Tu contenido está resonando en la comunidad. Sigue creando para crecer tu influencia.',
      ctaText: 'Ver actividad',
      footerNote: 'Responder a tu comunidad construye relaciones más fuertes.'
    },
  ...
  'pt-BR': {
    ...
    hostCreateMoment: {
      subject: 'Sua comunidade espera — crie seu primeiro Momento',
      title: 'Crie seu primeiro Momento',
      preheader: 'Sua comunidade espera conteúdo.',
      greeting: 'Olá {{name}},',
      intro: 'Você se cadastrou há {{days}} dias como Anfitrião e ainda não criou seu primeiro <strong>Momento</strong>.',
      chanceCopy: 'Momentos são sua chance de:',
      feature1: 'Compartilhar conteúdo exclusivo com sua comunidade',
      feature2: 'Aumentar o envolvimento com seus seguidores',
      feature3: 'Monetizar suas experiências mais valiosas',
      feature4: 'Crescer sua influência na plataforma',
      startLabel: 'Para começar',
      startValue: 'Leva 5 minutos',
      startSublabel: 'Envie uma foto, vídeo ou link e defina as regras de acesso',
      ctaText: 'Criar meu primeiro Momento',
      footerNote: 'Anfitriões que criam na primeira semana veem 3x mais envolvimento de seguidores.'
    },
    hostReengagement: {
      subject: 'Seus seguidores esperam seu próximo Momento',
      title: 'Seus seguidores sentem sua falta',
      preheader: 'Já faz um tempo desde o seu último Momento.',
      greeting: 'Olá {{name}},',
      intro: 'Já faz <strong>{{days}} dias</strong> desde o seu último Momento. Seus seguidores querem conteúdo novo.',
      lastLabel: 'Último Momento',
      lastValue: 'há {{days}} dias',
      activityLabel: 'Atividade dos seguidores',
      activityValue: 'Alta',
      nextCopy: 'Conteúdo novo mantém sua comunidade ativa e crescendo. O que você vai compartilhar agora?',
      ctaText: 'Criar novo Momento',
      footerNote: 'Anfitriões consistentes constroem audiências 5x maiores com o tempo.'
    },
    brandSponsor: {
      subject: 'Alcance audiências ativas — patrocine Momentos em alta',
      title: 'Patrocine Momentos de alto envolvimento',
      preheader: 'Coloque sua marca na frente de audiências engajadas.',
      greeting: 'Olá {{name}},',
      intro: 'Patrocinar um Momento é uma das formas mais eficazes de alcançar comunidades ativas na Promorang.',
      whyLabel: 'Por que patrocinar?',
      whyValue: '3x mais envolvimento',
      whySublabel: 'em relação à publicidade display tradicional',
      trendingLabel: 'Em alta agora',
      trendingCopy: 'Estes Momentos populares estão aceitando patrocínios:',
      byHost: 'por {{hostName}} • {{engagement}} interações',
      closeCopy: 'O patrocínio coloca sua mensagem em conteúdo que as pessoas estão consumindo agora.',
      ctaText: 'Ver oportunidades de patrocínio',
      footerNote: 'Há vagas limitadas por Momento — garanta sua vaga cedo.'
    },
    contentConsumption: {
      subject: '{{count}} novo(s) Momento(s) de criadores que você segue',
      title: 'Tem conteúdo esperando você',
      preheader: '{{count}} novo(s) Momento(s) de criadores que você segue.',
      greeting: 'Olá {{name}},',
      intro: 'Você tem <strong>{{count}} novo(s) Momento(s)</strong> de criadores que você segue.',
      featuredLabel: 'Momento em destaque',
      byHost: 'por {{hostName}}',
      missCopy: 'Não perca conteúdo exclusivo, acesso nos bastidores e ofertas dos seus criadores favoritos.',
      ctaText: 'Ver Momentos',
      footerNote: 'Interagir com conteúdo aumenta suas chances de desbloquear recompensas exclusivas.'
    },
    lowBudget: {
      subject: 'A campanha "{{campaignName}}" está com {{percent}}% do orçamento — adicione fundos',
      title: 'O orçamento da campanha está baixo',
      preheader: '{{percent}}% do orçamento restante para {{campaignName}}',
      greeting: 'Olá {{name}},',
      intro: 'Sua campanha <strong>{{campaignName}}</strong> está com pouco orçamento.',
      remainingLabel: 'Orçamento restante',
      remainingValue: '{{remaining}} Gems',
      remainingSublabel: '{{percent}}% de {{total}} Gems no total',
      campaignLabel: 'Campanha',
      statusLabel: 'Status',
      statusValue: 'Ativa (orçamento baixo)',
      topUpCopy: 'Recarregue em breve para a campanha não parar.',
      ctaText: 'Adicionar orçamento',
      footerNote: 'Campanhas com orçamento suficiente veem 40% mais conclusões.'
    },
    participationInterest: {
      subject: '{{requesterName}} quer entrar no seu Momento "{{momentTitle}}"',
      title: 'Novo pedido de participação',
      preheader: '{{requesterName}} quer entrar no seu Momento',
      greeting: 'Olá {{name}},',
      intro: '<strong>{{requesterName}}</strong> quer participar do seu Momento:',
      momentLabel: 'Momento',
      pendingCopy: '{{count}} pedidos pendentes no total',
      reviewCopy: 'Revise e aprove participantes para crescer sua comunidade em torno deste conteúdo.',
      ctaText: 'Revisar pedidos',
      footerNote: 'Aprovar participantes engajados aumenta o alcance e o valor do seu Momento.'
    },
    socialEngagement: {
      subject: '{{actorName}} {{verb}} seu conteúdo',
      title: 'Nova interação',
      preheader: '{{actorName}} {{verb}} seu conteúdo',
      greeting: 'Olá {{name}},',
      verbComment: 'comentou',
      verbLike: 'curtiu',
      verbShare: 'compartilhou',
      verbFollow: 'começou a seguir',
      yourContent: 'seu <strong>{{contentTitle}}</strong>',
      you: 'você',
      andOthers: 'e mais {{count}}',
      resonating: 'Seu conteúdo está ressoando na comunidade. Continue criando para crescer sua influência.',
      ctaText: 'Ver atividade',
      footerNote: 'Responder à sua comunidade constrói relações mais fortes.'
    },
