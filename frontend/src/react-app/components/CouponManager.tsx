  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Giveaways & Coupons</h2>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-xl border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-500">Active Incentives</p>
        ...
        <div className="rounded-xl border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900">{totalDistributed}</p>
            </div>
          </div>
        </div>
        <div className="rounded-xl border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-500">Recent Redemptions</p>
              <p className="text-2xl font-semibold text-gray-900">{redemptions.length}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {showCreateForm && (
        ...
        >
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">Create New Incentive</h3>
            <button
              type="button"
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Leaderboard Target</label>
              <select
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {coupons.map((coupon) => (
          <div key={coupon.id} className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="mt-2 text-lg font-semibold text-gray-900">{coupon.title}</h3>
                {coupon.description && <p className="mt-1 text-sm text-gray-600">{coupon.description}</p>}
              </div>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-dashed border-gray-200 p-3 text-sm">
                <p className="font-medium text-gray-700">Quick Assign</p>
                <div className="mt-3 space-y-3">
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-500">Attach to Drop</label>
                    <div className="flex items-center space-x-2">
                      <select
                        value={selectedDrop}
                        onChange={(event) => setSelectedDrop(event.target.value)}
                        className="flex-1 rounded-lg border border-gray-300 px-2 py-1 text-sm focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-200"
                      >
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-500">Leaderboard Reward</label>
                    <div className="flex items-center space-x-2">
                      <select
                        value={selectedLeaderboardRange}
                        onChange={(event) => setSelectedLeaderboardRange(event.target.value)}
      ...
      {redemptions.length > 0 && (
        <div className="rounded-2xl border border-gray-200 bg-white">
          <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
            <div>
              <p className="text-sm font-semibold text-gray-900">Recent Redemptions</p>
              <p className="text-xs text-gray-500">Track who has redeemed your incentives</p>
            </div>
          </div>
