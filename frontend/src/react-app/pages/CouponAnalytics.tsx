    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">{analytics.total_coupons}</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">{analytics.total_assigned}</p>
        </div>

        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center space-x-2 mb-2">
            <TrendingUp className="h-5 w-5 text-green-600" />
            <span className="text-sm font-medium text-gray-500">Redeemed</span>
          </div>
          <p className="text-3xl font-bold text-gray-900">{analytics.total_redeemed}</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">{analytics.redemption_rate}%</p>
        </div>

        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center space-x-2 mb-2">
            <DollarSign className="h-5 w-5 text-emerald-600" />
            <span className="text-sm font-medium text-gray-500">Value Distributed</span>
          </div>
          <p className="text-3xl font-bold text-gray-900">${analytics.total_value_distributed.toFixed(0)}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Top Performing Coupons */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Top Performing Coupons</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Assignments by Source</h2>
          <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Redemptions Over Time</h2>
          ...
          {analytics.redemptions_over_time.map((day, index) => {
            ...
            return (
              <div key={index} className="flex-1 flex flex-col items-center">
                ...
                />
                <p className="text-xs text-gray-500 mt-2">{new Date(day.date).getDate()}</p>
              </div>
            );
          })}
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-3">💡 Insights & Recommendations</h2>
