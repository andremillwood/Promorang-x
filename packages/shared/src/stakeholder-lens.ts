...
const ROLE_LENSES: Record<Exclude<StakeholderNavRole, "admin">, StakeholderLens> = {
  participant: lensParts("participant", {
    ...
    promise: "This card holds real offers from places around you. Browse one, put it on the card, then show it at the door.",
    ticker: "Your PromoCard",
    putIn: {
      label: "Browse perks",
      href: "/discover?tab=perks",
      detail: "A perk is a real offer a business put up — a free item, a deal, or entry. Pick one that is live. You do not have to answer a poll first.",
      stub: "PERKS",
    },
    promoCardMeaning: "What you can show at a door or counter right now.",
    worldLabel: "World",
    worldHref: "/discover?tab=perks",
    worldMeaning: "Live offers, nights, and places. Polls are optional city votes, not the store.",
    activityLabel: "Activity",
    activityHref: "/activity",
    activityMeaning: "A log of what you already claimed, used, or answered. Nothing here is required to start.",
  ...
  merchant: lensParts("merchant", {
    ...
    promise: "Run promotions that bring customers in, bring them back, and show verified business results.",
    ticker: "Turn customer activity into measurable business outcomes",
    putIn: {
      label: "Create promotion",
      href: "/dashboard?tab=promotions",
      detail: "Choose the business result you want, publish a customer promotion, and measure only what Promorang can verify.",
      stub: "PROMO",
    },
    promoCardMeaning: "What customers carry when they claim a promotion from your business.",
    worldLabel: "Customers",
    worldHref: "/dashboard?tab=customers",
    worldMeaning: "People who have claimed, redeemed, or otherwise created verified activity with your business.",
    activityLabel: "Results",
    activityHref: "/dashboard?tab=results",
    activityMeaning: "Verified redemptions, sales, repeat activity, and other evidence-backed business outcomes.",
    extras: [],
  }),
