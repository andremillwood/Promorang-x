...
const styles = StyleSheet.create({
  ...
  unavailableActionText: { color: Colors.black, fontSize: 13, fontWeight: '900' },
  ...
  label: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .8 },
  labelOutside: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .8, marginTop: 20, marginBottom: 9 },
  titleInput: { color: Colors.white, fontSize: 20, fontWeight: '700', paddingTop: 12, paddingBottom: 5 },
  count: { color: Colors.gray[600], fontSize: 12, textAlign: 'right', marginTop: 4 },
  types: { gap: 8 },
  ...
  typeText: { color: Colors.gray[300], fontSize: 12, fontWeight: '700' },
  ...
  preservedTitle: { color: Colors.white, fontSize: 13, fontWeight: '800' },
  preservedDetail: { color: Colors.gray[400], fontSize: 12, lineHeight: 14, marginTop: 3 },
