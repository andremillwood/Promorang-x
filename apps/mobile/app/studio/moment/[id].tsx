    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <View style={styles.operations}>
          <Operation icon="qr-code" title="Check guests in" detail="Scan a private pass or enter its code" route={`/guest-check-in?momentId=${moment.id}` as any} />
...
const styles = StyleSheet.create({
  ...
  publicLink: { color: Colors.primary, fontSize: 12, fontWeight: '700' },
  ...
  locationText: { color: Colors.gray[400], fontSize: 12 },
  ...
  editText: { color: Colors.white, fontSize: 12, fontWeight: '700' },
  ...
  pauseText: { color: Colors.white, fontSize: 12, fontWeight: '700' },
  ...
  sectionEyebrow: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: 1, marginTop: 23, marginBottom: 9 },
  ...
  metricLabel: { color: Colors.gray[300], fontSize: 12 },
  metricChange: { color: Colors.success, fontSize: 12, marginTop: 6 },
  ...
  liveText: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12 },
  ...
  operationTitle: { color: Colors.white, fontSize: 13, fontWeight: '800' },
  operationDetail: { color: Colors.gray[500], fontSize: 12, marginTop: 3 },
  ...
  pulseTitle: { color: Colors.white, fontSize: 13, fontWeight: '700' },
  ...
  pulseLabel: { color: Colors.gray[600], fontSize: 12 },
  ...
  afterTitle: { color: Colors.white, fontSize: 13, fontWeight: '800' },
  afterDetail: { color: Colors.gray[500], fontSize: 12, lineHeight: 14, marginTop: 3, paddingRight: 8 },
});
