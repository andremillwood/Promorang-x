...
const styles = StyleSheet.create({
  ...
  loadingText: { color: Colors.gray[400], fontSize: 13, marginTop: 10 },
  ...
  counterText: { color: Colors.gray[300], fontFamily: 'SpaceMono', fontSize: 12 },
  ...
  offlineText: { color: Colors.gray[300], fontSize: 12, flex: 1 },
  ...
  mediaTypeText: { color: Colors.white, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6 },
  ...
  evidenceMoment: { color: Colors.accent, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6, textTransform: 'uppercase' },
  ...
  personHandle: { color: Colors.gray[500], fontSize: 12, marginTop: 3 },
  ...
  reliabilityText: { color: Colors.success, fontSize: 12, fontWeight: '800' },
  sectionEyebrow: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: 1, marginTop: 21, marginBottom: 9 },
  ...
  signalLabel: { color: Colors.gray[500], fontSize: 12 },
  signalValue: { color: Colors.white, fontSize: 13, fontWeight: '700', marginTop: 2 },
  ...
  rewardLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6 },
  rewardTitle: { color: Colors.white, fontSize: 12, fontWeight: '800', marginTop: 4 },
  rewardDetail: { color: Colors.gray[400], fontSize: 12, marginTop: 3 },
  guidance: { color: Colors.gray[500], fontSize: 12, lineHeight: 14, textAlign: 'center', paddingHorizontal: 15, marginTop: 16 },
  ...
  rejectText: { color: Colors.white, fontSize: 13, fontWeight: '800' },
  ...
  approveText: { color: Colors.black, fontSize: 13, fontWeight: '900' },
  actionDisabled: { opacity: .62 },
  skip: { alignItems: 'center', padding: 14, backgroundColor: 'transparent' },
  skipText: { color: Colors.gray[500], fontSize: 12, fontWeight: '700' },
  ...
  completeEyebrow: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: 1, marginTop: 25 },
  ...
  completeWarning: { color: Colors.warning, fontSize: 12, textAlign: 'center', marginTop: 8 },
  ...
  completeButtonText: { color: Colors.black, fontSize: 13, fontWeight: '900' },
});
