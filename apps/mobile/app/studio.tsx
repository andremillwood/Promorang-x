...
const styles = StyleSheet.create({
  ...
  welcomeMeta: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .7 },
  welcomeTitle: { color: Colors.white, fontSize: 20, fontWeight: '800', marginTop: 6 },
  welcomeDetail: { color: Colors.gray[400], fontSize: 12, marginTop: 4 },
  ...
  liveText: { color: Colors.white, fontFamily: 'SpaceMono', fontSize: 12 },
  ...
  metricNoticeText: { color: Colors.gray[300], fontSize: 12, flex: 1 },
  ...
  metricLabel: { color: Colors.gray[300], fontSize: 12, marginTop: 2 },
  metricChange: { color: Colors.success, fontSize: 12, marginTop: 7 },
  metricChangeAttention: { color: Colors.warning },
  sectionEyebrow: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: 1, marginTop: 12, marginBottom: 10 },
  ...
  attentionDetail: { color: Colors.gray[500], fontSize: 12, marginTop: 3 },
  reviewButton: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 16, backgroundColor: Colors.primary },
  reviewText: { color: Colors.black, fontSize: 12, fontWeight: '900' },
  ...
  workMonth: { color: Colors.black, fontFamily: 'SpaceMono', fontSize: 12 },
  ...
  workStatusText: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .5 },
  workTitle: { color: Colors.white, fontSize: 12, fontWeight: '800', marginTop: 4 },
  workDetail: { color: Colors.gray[500], fontSize: 12, marginTop: 3 },
  ...
  emptyWorkDetail: { color: Colors.gray[500], fontSize: 12, lineHeight: 13, marginTop: 3 },
  ...
  actionLabel: { color: Colors.white, fontSize: 12, fontWeight: '700', flex: 1 },
  ...
  payoutMeta: { color: Colors.success, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6 },
  payoutValue: { color: Colors.white, fontSize: 13, fontWeight: '800', marginTop: 3 },
  payoutDetail: { color: Colors.gray[500], fontSize: 12, marginTop: 3 },
  ...
  fabText: { color: Colors.black, fontSize: 13, fontWeight: '900' },
});
