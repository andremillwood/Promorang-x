...
const s = StyleSheet.create({
  ...
  eyebrow: { fontFamily: 'SpaceMono', fontSize: 12, color: Colors.primary, letterSpacing: 1 },
  ...
  chipText: { color: 'white', fontSize: 12, fontWeight: '900' },
  ...
  copy: { flex: 1 },
  kind: { fontFamily: 'SpaceMono', fontSize: 12, color: Colors.primary },
