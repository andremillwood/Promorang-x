    ...
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.identity}>
          ...
          <Pressable style={styles.editButton} onPress={() => router.push('/settings' as any)}><Text style={styles.editText}>Manage profile & account</Text></Pressable>
        </View>
...
const styles = StyleSheet.create({
  ...
  roleText: { color: Colors.accent, fontSize: 10, fontWeight: '700', textTransform: 'capitalize' },
  ...
  editText: { color: Colors.white, fontSize: 11, fontWeight: '700' },
  ...
  statLabel: { color: Colors.gray[500], fontSize: 9, marginTop: 2 },
  divider: { width: StyleSheet.hairlineWidth, backgroundColor: Colors.border },
  sectionEyebrow: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 10, letterSpacing: 1, marginTop: 26, marginBottom: 10 },
  scenes: { gap: 9 },
  ...
  sceneTitle: { color: Colors.white, fontSize: 11, fontWeight: '700', marginTop: 12 },
  sceneDetail: { color: Colors.gray[500], fontSize: 9, marginTop: 3 },
  ...
  seeAll: { color: Colors.primary, fontSize: 11, fontWeight: '700' },
  ...
  proofDetail: { color: Colors.gray[500], fontSize: 9, marginTop: 3 },
  ...
  proofHint: { color: Colors.gray[500], fontSize: 9, marginTop: 8 },
  ...
  menuDetail: { color: Colors.gray[500], fontSize: 9, marginTop: 3 },
  ...
  progressionLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 8, letterSpacing: .6 },
  progressionTitle: { color: Colors.white, fontSize: 13, fontWeight: '800', marginTop: 3 },
  progressionDetail: { color: Colors.gray[400], fontSize: 9, lineHeight: 14, marginTop: 3 },
  ...
  signOutText: { color: Colors.gray[500], fontSize: 11, fontWeight: '700' },
});
