...
export default function CreateProposalScreen() {
  ...
  const submit = async (status: 'draft' | 'sent') => {
    ...
    try {
      ...
      Alert.alert('Activation plan saved', 'Nothing is live and no Gems have moved. Continue in the workspace to align the people, secure the full reserve, and open the Moment.', [{ text: 'Continue shaping', onPress: () => router.replace(`/proposal/${proposal.id}`) }]);
    } catch (error) {
  ...
  return <View style={styles.screen}>
    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.actions}>
        ...
        <Pressable disabled={!canContinue || createProposal.isPending} style={[styles.continue, (!canContinue || createProposal.isPending) && styles.disabled]} onPress={() => step < stepNames.length - 1 ? setStep(step + 1) : submit('draft')}>{createProposal.isPending ? <ActivityIndicator size="small" color={Colors.black} /> : <><Text style={styles.continueText}>{step < stepNames.length - 1 ? 'Continue' : 'Save activation plan'}</Text><Ionicons name="arrow-forward" size={17} color={Colors.black} /></>}</Pressable>
      </View>
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: Colors.black }, header: { paddingTop: Platform.OS === 'ios' ? 56 : 36, paddingHorizontal: Spacing.container, paddingBottom: 13, flexDirection: 'row', alignItems: 'center', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: Colors.border, backgroundColor: Colors.black }, close: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.gray[900], borderWidth: 1, borderColor: Colors.border }, heading: { flex: 1, marginLeft: 12, backgroundColor: 'transparent' }, eyebrow: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .9 }, headerTitle: { color: Colors.white, fontSize: 15, fontWeight: '800', marginTop: 2 }, stepCount: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 12 }, progress: { flexDirection: 'row', gap: 5, paddingHorizontal: Spacing.container, paddingVertical: 11, backgroundColor: Colors.black }, progressItem: { flex: 1, backgroundColor: 'transparent' }, progressBar: { height: 3, borderRadius: 2, backgroundColor: Colors.gray[800] }, progressBarActive: { backgroundColor: Colors.primary }, progressName: { color: Colors.gray[700], fontSize: 12, textAlign: 'center', marginTop: 5 }, progressNameActive: { color: Colors.white, fontWeight: '700' }, content: { paddingHorizontal: Spacing.container, paddingTop: 20 }, stepIntro: { backgroundColor: 'transparent' }, stepEyebrow: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .9 }, title: { color: Colors.white, fontSize: Typography.sizes['2xl'], lineHeight: 31, fontWeight: '800', letterSpacing: -.7, marginTop: 7 }, subtitle: { color: Colors.gray[400], fontSize: 13, lineHeight: 17, marginTop: 7 }, cards: { gap: 9, marginTop: 18, backgroundColor: 'transparent' }, selectCard: { flexDirection: 'row', alignItems: 'center', padding: 14, borderRadius: BorderRadius.xl, backgroundColor: Colors.gray[900], borderWidth: 1, borderColor: Colors.border }, selectCardActive: { borderColor: Colors.primary, backgroundColor: '#24160F' }, selectIcon: { width: 40, height: 40, borderRadius: 13, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.ambientWash, marginRight: 11 }, selectIconActive: { backgroundColor: Colors.primary }, selectCopy: { flex: 1, backgroundColor: 'transparent' }, selectTitle: { color: Colors.white, fontSize: 12, fontWeight: '800' }, selectDetail: { color: Colors.gray[500], fontSize: 12, lineHeight: 14, marginTop: 3, paddingRight: 8 }, inputBlock: { marginTop: 15, padding: 14, borderRadius: BorderRadius.xl, backgroundColor: Colors.gray[900], borderWidth: 1, borderColor: Colors.border }, label: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .7, marginBottom: 8 }, input: { color: Colors.white, fontSize: 13, paddingVertical: 6 }, textArea: { color: Colors.white, fontSize: 13, lineHeight: 19, minHeight: 88, textAlignVertical: 'top' }, chipGroup: { marginTop: 19, backgroundColor: 'transparent' }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, backgroundColor: 'transparent' }, chip: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 11, paddingVertical: 9, borderRadius: 18, backgroundColor: Colors.gray[900], borderWidth: 1, borderColor: Colors.border }, chipActive: { backgroundColor: Colors.primary, borderColor: Colors.primary }, chipText: { color: Colors.gray[300], fontSize: 12, fontWeight: '700' }, chipTextActive: { color: Colors.black }, sharedReturn: { flexDirection: 'row', marginTop: 20, padding: 14, borderRadius: BorderRadius.xl, backgroundColor: '#24160F', borderWidth: 1, borderColor: 'rgba(255,106,26,.24)' }, sharedCopy: { flex: 1, marginLeft: 10, backgroundColor: 'transparent' }, sharedLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6 }, sharedText: { color: Colors.white, fontSize: 12, lineHeight: 15, fontWeight: '700', marginTop: 4 }, actions: { flexDirection: 'row', gap: 10, marginTop: 18, backgroundColor: 'transparent' }, back: { height: 48, paddingHorizontal: 16, flexDirection: 'row', gap: 7, alignItems: 'center', justifyContent: 'center', borderRadius: 16, borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.gray[900] }, backText: { color: Colors.white, fontSize: 13, fontWeight: '800' }, continue: { flex: 1, height: 48, flexDirection: 'row', gap: 7, alignItems: 'center', justifyContent: 'center', borderRadius: 16, backgroundColor: Colors.primary }, continueText: { color: Colors.black, fontSize: 13, fontWeight: '900' }, disabled: { opacity: .4 }, draft: { alignItems: 'center', padding: 13 }, draftText: { color: Colors.gray[400], fontSize: 12, fontWeight: '700' },
  ...
  gemsNoteText: { color: Colors.gray[200], fontSize: 12, lineHeight: 15, fontWeight: '700' },
  changeScene: { alignItems: 'center', paddingVertical: 10 }, changeSceneText: { color: Colors.primary, fontSize: 12, fontWeight: '800' },
  ...
  sceneTestLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .7 },
  sceneTestTitle: { color: Colors.white, fontSize: 14, lineHeight: 19, fontWeight: '800', marginTop: 6 },
  sceneTestCopy: { color: Colors.gray[400], fontSize: 12, lineHeight: 15, marginTop: 5 },
  ...
  storyNumberText: { color: Colors.primary, fontSize: 12, fontWeight: '900' }, storyPhaseText: { color: Colors.gray[300], fontSize: 12, fontWeight: '700', marginTop: 5 },
  storyCard: { marginTop: 18, padding: 18, borderRadius: 24, backgroundColor: '#11100E', borderWidth: 1, borderColor: 'rgba(255,106,26,.3)' },
  storyScene: { alignSelf: 'flex-start', backgroundColor: Colors.primary, borderRadius: 14, paddingHorizontal: 10, paddingVertical: 5 }, storySceneText: { color: Colors.black, fontSize: 12, fontWeight: '900', textTransform: 'uppercase' },
  storyTitle: { color: Colors.white, fontSize: 28, lineHeight: 31, fontWeight: '900', letterSpacing: -1, marginTop: 15 }, storyLocation: { color: Colors.primary, fontSize: 12, fontWeight: '800', marginTop: 7 }, storyDescription: { color: Colors.gray[300], fontSize: 13, lineHeight: 17, marginTop: 12 },
  storyOutcome: { marginTop: 15, paddingLeft: 12, borderLeftWidth: 2, borderLeftColor: Colors.primary }, storyOutcomeText: { color: Colors.white, fontSize: 13, lineHeight: 17, fontWeight: '800' },
  reviewStack: { gap: 8, marginTop: 10, backgroundColor: 'transparent' }, reviewSignal: { flexDirection: 'row', padding: 13, borderRadius: 16, backgroundColor: Colors.gray[900], borderWidth: 1, borderColor: Colors.border }, reviewIcon: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.ambientWash }, reviewCopy: { flex: 1, marginLeft: 10, backgroundColor: 'transparent' }, reviewLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .5 }, reviewValue: { color: Colors.gray[200], fontSize: 12, lineHeight: 15, fontWeight: '700', marginTop: 4, textTransform: 'capitalize' },
  afterCard: { marginTop: 10, padding: 14, borderRadius: 16, backgroundColor: Colors.black, borderWidth: 1, borderColor: Colors.border }, afterLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6 }, afterText: { color: Colors.gray[300], fontSize: 12, lineHeight: 15, marginTop: 5 },
  ...
  guidanceLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .7 },
  ...
  guidanceRowLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6, textTransform: 'uppercase' },
  guidanceRowText: { color: Colors.gray[300], fontSize: 12, lineHeight: 15, marginTop: 4 },
  guidanceAvoid: { color: Colors.gray[400], fontSize: 12, lineHeight: 15, marginTop: 12 },
