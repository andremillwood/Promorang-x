...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 9, letterSpacing: 1.1, marginTop: 20, marginBottom: 9 },
  ...
  rowDetail: { color: Colors.gray[500], fontSize: 10, lineHeight: 15, marginTop: 2 },
  rowAction: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 99, backgroundColor: Colors.ambientWash },
  rowActionText: { color: Colors.primary, fontSize: 10, fontWeight: '900' },
  ...
  dangerDetail: { color: Colors.gray[400], fontSize: 9, lineHeight: 14, marginTop: 2 },
  ...
  deleteText: { color: Colors.error, fontSize: 10, fontWeight: '900' },
  retention: { color: Colors.gray[600], fontSize: 9, lineHeight: 14, marginTop: 9 },
});
