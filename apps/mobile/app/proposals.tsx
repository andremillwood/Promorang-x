...
const styles = StyleSheet.create({
  ...
  heading: { flex: 1, marginLeft: 12, backgroundColor: 'transparent' }, eyebrow: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 8, letterSpacing: .9 }, headerTitle: { color: Colors.white, fontWeight: '800', fontSize: 16, marginTop: 2 },
  addButton: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.primary },
  intro: { paddingHorizontal: Spacing.container, paddingTop: 22, paddingBottom: 9, backgroundColor: Colors.black }, introTitle: { color: Colors.white, fontSize: Typography.sizes['2xl'], lineHeight: 30, fontWeight: '900', letterSpacing: -.7 }, introCopy: { color: Colors.gray[500], fontSize: 11, lineHeight: 17, marginTop: 7 },
  loading: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.black }, loadingText: { color: Colors.gray[500], fontSize: 10, marginTop: 10 }, list: { padding: Spacing.container, gap: 14, paddingBottom: 50 },
  card: { padding: 17, borderRadius: 24, backgroundColor: Colors.gray[900], borderWidth: 1, borderColor: Colors.border }, cardTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'transparent' }, status: { backgroundColor: '#26160E', borderWidth: 1, borderColor: 'rgba(255,106,26,.3)', borderRadius: 15, paddingHorizontal: 9, paddingVertical: 5 }, statusText: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 7, letterSpacing: .6 }, date: { color: Colors.gray[600], fontSize: 8 },
  scene: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 8, letterSpacing: .8, marginTop: 17 }, title: { color: Colors.white, fontSize: 23, lineHeight: 27, fontWeight: '900', letterSpacing: -.5, marginTop: 5 }, description: { color: Colors.gray[400], fontSize: 10, lineHeight: 16, marginTop: 8 },
  storyRow: { flexDirection: 'row', gap: 8, marginTop: 16, backgroundColor: 'transparent' }, story: { flex: 1, minHeight: 94, padding: 12, borderRadius: BorderRadius.lg, backgroundColor: Colors.black, borderWidth: 1, borderColor: Colors.border }, storyLabel: { color: Colors.gray[600], fontFamily: 'SpaceMono', fontSize: 7, letterSpacing: .5, marginTop: 10 }, storyText: { color: Colors.gray[300], fontSize: 9, lineHeight: 13, fontWeight: '700', marginTop: 3 },
  returnBox: { marginTop: 9, padding: 13, borderRadius: BorderRadius.lg, backgroundColor: '#17110D', borderWidth: 1, borderColor: 'rgba(255,106,26,.18)' }, returnLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 7, letterSpacing: .55 }, returnText: { color: Colors.gray[300], fontSize: 9, lineHeight: 14, marginTop: 5 },
  next: { marginTop: 15, paddingTop: 14, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: Colors.border, flexDirection: 'row', alignItems: 'center', backgroundColor: 'transparent' }, nextCopy: { flex: 1, backgroundColor: 'transparent' }, nextLabel: { color: Colors.gray[600], fontFamily: 'SpaceMono', fontSize: 7, letterSpacing: .5 }, nextText: { color: Colors.white, fontSize: 9, lineHeight: 14, fontWeight: '700', marginTop: 4, paddingRight: 12 }, arrow: { width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.primary },
  empty: { alignItems: 'center', paddingTop: 65, paddingHorizontal: 25, backgroundColor: Colors.black }, emptyIcon: { width: 58, height: 58, borderRadius: 29, alignItems: 'center', justifyContent: 'center', backgroundColor: '#24160F' }, emptyTitle: { color: Colors.white, textAlign: 'center', fontSize: 23, lineHeight: 28, fontWeight: '900', marginTop: 18 }, emptyCopy: { color: Colors.gray[500], textAlign: 'center', fontSize: 11, lineHeight: 17, marginTop: 8 }, primaryButton: { height: 48, marginTop: 22, paddingHorizontal: 18, flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 16, backgroundColor: Colors.primary }, primaryText: { color: Colors.black, fontSize: 11, fontWeight: '900' },
});
