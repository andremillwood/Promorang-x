...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 9, letterSpacing: 1 },
  ...
  number: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 9, width: 34 },
  ...
  kind: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 7, letterSpacing: .6 },
  resultTitle: { color: Colors.white, fontSize: 12, fontWeight: '800', marginTop: 3 },
  detail: { color: Colors.gray[500], fontSize: 9, marginTop: 3 },
});
