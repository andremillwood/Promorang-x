    ...
    <View style={styles.screen}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.body}>
          ...
          <Text style={styles.sectionEyebrow}>YOUR ACTION</Text>
          <View style={styles.actionCard}>
            <View style={styles.actionTop}><View style={styles.actionIcon}><Ionicons name="location" size={21} color={Colors.primary} /></View><View style={styles.actionCopy}><Text style={styles.actionTitle}>Let the host know you made it</Text><Text style={styles.actionDetail}>Check in here and add a capture if the Moment asks for one.</Text></View><Text style={styles.gemReward}>{rewardLabel}</Text></View>
            <View style={styles.proofRow}><Proof icon="navigate" text="Be at the place" /><Proof icon="camera" text="Add one capture" /></View>
            <View style={styles.actionButtons}>
              <Pressable style={styles.checkIn} onPress={() => router.push('/check-in')}><Text style={styles.checkInText}>Check in</Text><Ionicons name="arrow-forward" size={17} color={Colors.black} /></Pressable>
      ...
      <View style={styles.sticky}>
        ...
        <Pressable style={[styles.goingButton, going && styles.goingButtonActive]} onPress={() => setGoing(!going)}><Ionicons name={going ? 'checkmark' : 'add'} size={18} color={Colors.black} /><Text style={styles.goingText}>{going ? 'You’re going' : 'I’m going'}</Text></Pressable>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  notFoundActionText: { color: Colors.black, fontSize: 11, fontWeight: '900' },
  ...
  liveText: { color: Colors.white, fontFamily: 'SpaceMono', fontSize: 9, letterSpacing: .6 },
  location: { color: Colors.accent, fontFamily: 'SpaceMono', fontSize: 10, letterSpacing: .7, marginTop: 15, textTransform: 'uppercase' },
  ...
  hostLabel: { color: Colors.gray[300], fontFamily: 'SpaceMono', fontSize: 8, letterSpacing: .6 },
  ...
  factLabel: { color: Colors.gray[500], fontSize: 9, marginTop: 5 },
  factValue: { color: Colors.white, fontSize: 11, fontWeight: '700', marginTop: 2 },
  factDivider: { width: StyleSheet.hairlineWidth, backgroundColor: Colors.border },
  sectionEyebrow: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 10, letterSpacing: 1, marginTop: 25, marginBottom: 9 },
  ...
  peopleTitle: { color: Colors.white, fontSize: 11, fontWeight: '700' },
  peopleDetail: { color: Colors.gray[500], fontSize: 9, marginTop: 3 },
  ...
  actionDetail: { color: Colors.gray[500], fontSize: 9, marginTop: 3 },
  ...
  proofText: { color: Colors.gray[300], fontSize: 9 },
  ...
  valueEyebrow: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 8, letterSpacing: .6 },
  valueTitle: { color: Colors.white, fontSize: 12, fontWeight: '800', marginTop: 4 },
  valueDetail: { color: Colors.gray[400], fontSize: 9, marginTop: 3 },
  ...
  growEyebrow: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 8, letterSpacing: .6 },
  growTitle: { color: Colors.white, fontSize: 14, fontWeight: '800', marginTop: 4 },
  growDetail: { color: Colors.gray[500], fontSize: 9, lineHeight: 14, marginTop: 3, maxWidth: 280 },
  ...
  stickyLabel: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 8, letterSpacing: .7 },
