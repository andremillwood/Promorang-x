...
const styles = StyleSheet.create({
  ...
  typeText: { color: Colors.white, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .7 },
  ...
  signal: { color: Colors.accent, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6, textTransform: 'uppercase' },
  ...
  cardMeta: { color: Colors.gray[200], fontSize: 12, flex: 1 },
  ...
  emptyDetail: { color: Colors.gray[400], fontSize: 13, lineHeight: 17, textAlign: 'center', marginTop: 6, maxWidth: 280 },
  ...
  collectionDetail: { color: Colors.gray[500], fontSize: 12, marginTop: 3 },
  ...
  syncWarningText: { color: Colors.gray[300], fontSize: 12, lineHeight: 14, flex: 1 },
});
