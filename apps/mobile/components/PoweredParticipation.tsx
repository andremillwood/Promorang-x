...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .8 },
  title: { color: Colors.white, fontSize: 19, lineHeight: 24, fontWeight: '800', letterSpacing: -.45, marginTop: 8, maxWidth: 310 },
  intro: { color: Colors.gray[400], fontSize: 13, lineHeight: 17, marginTop: 8 },
  ...
  stepLabel: { color: Colors.white, fontSize: 12, fontWeight: '800', marginTop: 7 },
  stepDetail: { color: Colors.gray[600], fontSize: 12, lineHeight: 10, textAlign: 'center', marginTop: 2, maxWidth: 66 },
  ...
  funderLabel: { color: Colors.gray[500], fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .5 },
  funderName: { color: Colors.white, fontSize: 13, fontWeight: '800', marginTop: 4 },
  funderDetail: { color: Colors.gray[500], fontSize: 12, lineHeight: 14, marginTop: 3 },
  ...
  unlockLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6 },
  unlockValue: { color: Colors.white, fontSize: 13, fontWeight: '700', lineHeight: 16, marginTop: 4 },
  ...
  contentActionLabel: { color: Colors.primary, fontFamily: 'SpaceMono', fontSize: 12, letterSpacing: .6 },
  contentActionTitle: { color: Colors.white, fontSize: 13, fontWeight: '800', marginTop: 4 },
  contentActionDetail: { color: Colors.gray[500], fontSize: 12, lineHeight: 14, marginTop: 3, maxWidth: 285 },
});
