...
export const VERIFIED_VENUES: VenueItem[] = [
  ...
  },
  {
    ...
    location: "Oxford Rd (Next to Emancipation Park), New Kingston",
    address: "Oxford Rd, New Kingston",
    neighborhood: "New Kingston / Emancipation Park",
    city: "Kingston",
    venue_type: "culinary",
    venue_type_label: "Open-Air Jerk & Bar",
    capacity: 250,
    latitude: 18.0016,
    longitude: -76.7904,
