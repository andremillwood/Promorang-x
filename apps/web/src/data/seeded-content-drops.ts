...
export const seededContentDrops: ContentDistributionCampaign[] = [
  {
    ...
    title: "Release room: first listen",
    description:
      "Maya put the original up. Listen there, then join the listening room if you want the Promorang catch. Sharing does not pay.",
    objective_type: "content_launch",
    status: "active",
    starts_at: "2026-09-01T14:00:00.000Z",
    ends_at: "2026-12-31T03:59:00.000Z",
    reward_config: {
      base_points: 4,
    ...
    content_distribution_assets: [
      {
        ...
        description: "The original. Open it where it lives, then take the room.",
        asset_type: "video",
  ...
  },
  {
    ...
    title: "Market run: pickup reel",
    description:
      "Kai put the reel up. Watch the original, then claim the pickup perk. Reposting is not the payday.",
    objective_type: "content_launch",
    status: "active",
    ...
    promoshare_config: {
      enabled: true,
      actions: ["click", "proof_verified", "claim"],
    ...
    metadata: {
      ...
      release_kind: "video",
      linked_offer_id: "seed-offer-pickup",
      brief: "Watch the original, then claim pickup.",
    },
    content_distribution_assets: [
      {
