...
export const DISCOVERY_POLLS: DiscoveryPoll[] = [
  {
    ...
    authorRole: 'Senior FMCG & Culinary Scout',
    description: 'Arla Pro Whip & Cook is a versatile European dairy blend engineered to perform in high-heat savory dishes without curdling and whip to 3.5× volume for pastries and desserts. We are polling local home chefs, caterers, and food lovers to establish market-clearing price expectation.',
    contextNotes: 'When this demand signal reaches 160 verified votes, Promorang and Arla Pro will unlock special introductory sampling vouchers and wholesale case access across participating supermarkets.',
    totalVotes: 158,
    thresholdForMoment: 160,
    targetUnlockPerk: 'J$500 Off 1L Carton Tasting Voucher at Select Grocers',
    pointsReward: 25,
    options: [
    ...
    tags: ['Arla Pro', 'Culinary', 'Dairy', 'Baking', 'Price Discovery'],
    comments: [
      {
        id: 'c1',
        author: 'Chef Danielle',
        badge: 'Verified Caterer',
        optionSupported: 'J$1,000 – J$1,499 (Roadshow Price approx. J$1,200)',
      ...
      },
      {
        ...
        optionSupported: 'J$1,500 – J$1,999',
  ...
  },
  {
    ...
    description: 'Summer 2026 is wrapping up with major festival weekends, beachfront takeovers, and intimate culinary sessions. Vote on your primary celebration mode to help us curate exclusive PromoKeys with top event organizers.',
    contextNotes: 'Reaching 150 votes triggers a sponsored beachfront sunset pop-up lounge with complimentary welcome cocktails for all verified voters.',
    totalVotes: 142,
    thresholdForMoment: 150,
    targetUnlockPerk: 'Dedicated Promorang Beachfront Sunset Moment + Free Entry Keys',
    pointsReward: 50,
    options: [
    ...
    tags: ['Summer 2026', 'Beach Party', 'Concerts', 'Nightlife', 'Jamaica Events'],
    comments: [
      {
        id: 'c1',
        author: 'Rohan P.',
        badge: 'Scene Pioneer',
        optionSupported: 'Beach party & oceanfront vibes',
        text: 'Nothing beats taking the highway down to Ocho Rios or Maiden Cay for the final summer weekend. Pure sun and water!',
        likes: 24,
        timeAgo: '2 hours ago'
      },
      {
  ...
  },
  {
    ...
    description: 'We are working alongside Midas Live and Jamaican entertainment producers to design crowd-first concert experiences, acoustic showcases, and sound clashes with seamless ticketing and backstage perks.',
    contextNotes: 'Unlocking 100 votes will trigger 20 free VIP Backstage Guest Passes to the upcoming Midas Live Showcase.',
    totalVotes: 98,
    thresholdForMoment: 100,
    targetUnlockPerk: '20 VIP Access Keys + Backstage Soundcheck Invitation',
    pointsReward: 30,
    options: [
    ...
    tags: ['Live Music', 'Reggae', 'Dancehall', 'Midas Live', 'Concerts'],
    comments: [
      {
        id: 'c1',
        author: 'Jahson K.',
        badge: 'Sound System Collector',
  ...
  },
  {
    ...
    description: 'The great Kingston Friday Jerk debate. Everyone has their loyalty between Sweetwood, Scotchies, Boston Jerk on the Waterfront, and Pepperwood. Help settle the ranking and unlock an exclusive 15-Key Jerk & Craft Beer tasting run.',
    contextNotes: 'Reaching 120 votes unlocks a dedicated Promorang Tasting Pass with 25% off signature platters at the winning jerk center!',
    totalVotes: 112,
    thresholdForMoment: 120,
    targetUnlockPerk: 'Exclusive Jerk Platter & Craft Beer Tasting Pass (Winning Venue)',
    pointsReward: 35,
    options: [
