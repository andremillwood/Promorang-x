...
const AboutPromorang = lazy(() => import("./pages/AboutPromorang"));
              ...
              <DemoExperienceProvider>
                ...
                <ChunkErrorBoundary>
                  ...
                  <Route element={<AppLayout />}>
                    ...
                    <Route path="/about" element={<AboutPromorang />} />
                    ...
                    <Route path="/radar" element={<Navigate to="/discover/moments" replace />} />
                    <Route path="/opportunity-radar" element={<Navigate to="/discover/moments" replace />} />
