...
export function PromoCardGateway() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10 bg-[#070707] text-white">
      ...
      <div className="container relative px-5 pb-14 pt-24 sm:px-6 sm:pb-20 sm:pt-28 lg:pt-32">
        <div className="grid items-center gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-amber-300/25 bg-amber-300/10 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.16em] text-amber-200">
              <Sparkles className="h-3.5 w-3.5" />
              Promorang’s member spending benefit
            </div>
            <h1 className="mt-5 max-w-2xl text-[clamp(2.6rem,12vw,6.4rem)] font-black uppercase leading-[0.86] tracking-[-0.07em]">
              Spend less.<br />
            ...
            <div className="mt-6 grid gap-3 sm:flex">
              <Link
                ...
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-primary px-6 text-sm font-black text-white shadow-[0_18px_50px_rgba(255,85,0,0.28)] transition hover:bg-orange-600 active:scale-[0.98]"
              >
          ...
          <div className="relative mx-auto w-full max-w-xl">
            ...
            <div className="relative overflow-hidden rounded-[1.75rem] border border-amber-200/20 bg-gradient-to-br from-zinc-800 via-zinc-950 to-black p-5 shadow-[0_32px_100px_rgba(0,0,0,0.65)] sm:p-7">
              ...
              <div className="mt-5 flex items-start gap-2 border-t border-white/10 pt-4 text-[10px] leading-4 text-white/45">
