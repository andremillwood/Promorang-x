...
export function MobileNotificationBridgeBanner() {
  ...
  return (
    <>
      <div className="rounded-2xl border border-primary/30 bg-card p-4 text-foreground shadow-lg flex items-center justify-between gap-4 animate-in fade-in-50 duration-300">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <p className="text-xs font-black uppercase tracking-wider text-foreground">{t("notificationBridge.title")}</p>
      ...
      <Dialog open={openModal} onOpenChange={setOpenModal}>
        <DialogContent className="sm:max-w-md p-6 bg-popover text-popover-foreground border-border rounded-3xl shadow-2xl">
          <DialogHeader className="text-center pb-2">
            <div className="mx-auto h-12 w-12 rounded-2xl bg-primary/20 text-primary flex items-center justify-center mb-2">
              <QrCode className="h-6 w-6" />
            </div>
            <DialogTitle className="text-xl font-black text-foreground">{t("notificationBridge.modalTitle")}</DialogTitle>
          ...
          <div className="flex flex-col items-center py-3 space-y-4">
            ...
            <div className="w-full space-y-2 text-xs text-muted-foreground bg-muted p-3 rounded-2xl border border-border">
            ...
            <Button
              ...
              className="w-full rounded-xl border-border hover:bg-accent text-foreground font-bold text-xs"
            >
              Done
            </Button>
          </div>
