        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-2xl font-black text-white">{t("hostImpact.title")}</h2>
            ...
            <p className="text-xs text-white/60 mt-1">
              {t("hostImpact.subtitle")}
            </p>
          </div>
        </div>

        <div className="px-4 py-2 rounded-2xl border border-white/10 bg-white/5 text-center">
          <p className="text-[10px] uppercase font-bold text-white/50">{t("hostImpact.returnLabel")}</p>
          <p className="text-base font-black text-emerald-400">{t("hostImpact.returnValue")}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 rounded-3xl border border-white/10 bg-[#0e1015] flex flex-col justify-between space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-[10px] uppercase font-bold text-white/50">{t("hostImpact.guests")}</span>
          ...
          <div>
            ...
            <p className="text-xs text-amber-300 font-semibold mt-1">{t("hostImpact.guestsHint", { count: 14 })}</p>
          </div>
        </div>

        <div className="p-5 rounded-3xl border border-white/10 bg-[#0e1015] flex flex-col justify-between space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-[10px] uppercase font-bold text-white/50">{t("hostImpact.gems")}</span>
          ...
          <div>
            ...
            <p className="text-xs text-primary font-semibold mt-1">{t("hostImpact.gemsHint")}</p>
          </div>
        </div>

        <div className="p-5 rounded-3xl border border-white/10 bg-[#0e1015] flex flex-col justify-between space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-[10px] uppercase font-bold text-white/50">{t("hostImpact.points")}</span>
          ...
          <div>
            ...
            <p className="text-xs text-cyan-300 font-semibold mt-1">{t("hostImpact.pointsHint")}</p>
          </div>
        </div>

        <div className="p-5 rounded-3xl border border-white/10 bg-[#0e1015] flex flex-col justify-between space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-[10px] uppercase font-bold text-white/50">{t("hostImpact.rating")}</span>
          ...
          <div>
            ...
            <p className="text-xs text-emerald-400 font-semibold mt-1">{t("hostImpact.ratingHint")}</p>
          </div>
        </div>
      </div>
