...
const pageLabels: Array<{ match: string; label: string; description: string }> = [
  ...
  { match: "/nodes", label: "Nodes & Jackpot", description: "100% Principal-protected liquidity yield and weekly/monthly cash prize pools." },
...
const roleNavItems: Record<UserRole, NavItem[]> = {
  participant: [
    ...
    { icon: Coins, label: "Nodes & Jackpot", href: "/nodes", group: "primary" },
  ...
  merchant: [
    ...
    { icon: Coins, label: "Liquidity Nodes", href: "/nodes", group: "primary" },
  ...
  admin: [
    ...
    { icon: Coins, label: "Community Nodes", href: "/nodes", group: "primary" },
    { icon: Compass, label: "Discover", href: "/discover", group: "primary" },
