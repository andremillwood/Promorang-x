...
const pageLabels: Array<{ match: string; label: string; description: string }> = [
  ...
  { match: "/wallet", label: "Wallet", description: "Refill and extras — Points, Keys, and Gems." },
  ...
  { match: "/card", label: "PromoCard", description: "Show this at checkout, or the next thing that lands on it." },
