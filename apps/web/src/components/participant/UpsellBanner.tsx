        ...
        <div className="relative group overflow-hidden rounded-[2rem] border border-primary/20 bg-gradient-to-br from-primary/10 via-background to-accent/5 p-8 transition-all duration-500 hover:shadow-soft-xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-shrink-0 w-24 h-24 rounded-3xl bg-primary/20 border-2 border-primary/30 flex items-center justify-center relative shadow-soft">
                    ...
                    <div className="absolute -top-2 -right-2 bg-primary text-primary-foreground text-[10px] font-bold px-2 py-1 rounded-lg uppercase tracking-widest shadow-lg">
                        RANK 1
                    </div>
                </div>
                ...
                <div className="flex-1 text-center md:text-left">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-[10px] font-bold uppercase tracking-widest mb-3">
                        ...
                        Rank Progression Active
                    </div>
                    <h3 className="font-serif text-2xl md:text-3xl font-bold text-foreground mb-2">
                        Earn <span className="text-primary italic">Priority Access</span> & Rewards
                    </h3>
                    <p className="text-muted-foreground max-w-xl text-sm md:text-base mb-6 font-medium">
                        You've attended 3 moments this month! Maintain your consistency to unlock higher **Access Ranks** and get first dibs on exclusive brand drops.
                    </p>
                ...
                <div className="flex-shrink-0">
                    <Button asChild variant="outline" size="lg" className="rounded-2xl px-8 group shadow-soft border-secondary/30 hover:bg-secondary/10 hover:text-secondary">
                        <Link to="/dashboard/rewards" className="flex items-center gap-2">
                            View Progression
