...
type Tier = { id: string; name: string; description: string | null; access_type: string; price: number; currency: string; capacity: number | null; issued_count: number; reward_summary: string | null; status: string };
type Pass = { id: string; tier_id: string; pass_code: string; status: string };
