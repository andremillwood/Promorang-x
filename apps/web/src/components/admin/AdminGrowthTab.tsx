    ...
    <div className="space-y-8">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground">The north star is verified outcomes generated by active Moments. Everything else explains how people reached and repeated that outcome.</p>
        </div>
      ...
      <section className="rounded-2xl border bg-card p-5">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Register the hypothesis before shipping the treatment. New experiments start as drafts with a 50/50 control and treatment split.</p>
