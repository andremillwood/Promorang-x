...
export function CreatorMissionsHub() {
  ...
  const handleClaim = (bountyTitle: string, bountyId: string) => {
    ...
    toast({
      title: "Creator Bounty Claimed! 🎯",
      description: `Claimed '${bountyTitle}'. Submit your deliverable link before Sunday 11:59 PM.`,
    });
  };
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-2xl font-black text-white">Live Creator Missions & Bounty Board</h2>
            ...
            <p className="text-xs text-white/60 mt-1">
              Claim sponsored creator briefs, film cultural moments, and receive instant cash payouts upon review.
            </p>
          </div>
        </div>

        <div className="px-4 py-2 rounded-2xl border border-white/10 bg-white/5 text-center">
          <p className="text-[10px] uppercase font-bold text-white/50">Avg Bounty Value</p>
          <p className="text-base font-black text-purple-400">$165.00</p>
        </div>
      </div>
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="pt-2 border-t border-white/5 flex items-center justify-between">
                  <span className="text-[11px] text-white/50">
                    {bounty.claimedCount} / {bounty.slotsAvailable} claimed
                  </span>
