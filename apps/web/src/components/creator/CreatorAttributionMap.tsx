        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-2xl font-black text-white">Smart Attribution & O2O Tracking Hub</h2>
              <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-[10px] font-extrabold uppercase">
                158 Footfalls Attributed
              </span>
            </div>
            <p className="text-xs text-white/60 mt-1">
              Generate custom tracked links, QR codes, and measure physical footfalls generated by your social posts.
            </p>
          </div>
        </div>

        <div className="px-4 py-2 rounded-2xl border border-white/10 bg-white/5 text-center">
          <p className="text-[10px] uppercase font-bold text-white/50">Footfall Bounty Yield</p>
          <p className="text-base font-black text-purple-400">$3.50 / Visit</p>
        </div>
      </div>
