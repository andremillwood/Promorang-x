...
const fallbackContentSlides: HeroSlide[] = [
  {
    ...
    reward: "Listen or watch the original, then take the room or perk",
    marks: "Release-led action",
    href: "/content-drops",
    icon: PlayCircle,
  },
  {
    ...
    reward: "Watch the episode, then join the room if one is attached",
    marks: "Release + room",
    href: "/content-drops",
    icon: PlayCircle,
  },
  {
    ...
    reward: "Watch the original, then claim the attached perk",
    marks: "Release + perk",
    href: "/content-drops",
    icon: PlayCircle,
  },
