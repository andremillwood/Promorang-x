...
export const CURATED_KINGSTON_MOMENTS: MomentProps[] = [
  ...
  },
  {
    ...
    description: "Presented by Midas Entertainment & 8Rivaz Ultra Lounge. The high-energy live reggae concert at Plantation Cove, St. Ann headlined by Capleton ('The Fireman' / King Shango), featuring Nesbeth and Dean Fraser, with entertainment by DJ Delano (Renaissance), Bass Odyssey, and DJ Rors. Admission: J$5,000 Pre-sold | J$7,000 at Gate. Tickets available online at aitix.app/culturerising.",
    intentType: 'ATTEND',
    ownership: 'PROMORANG PRESENTS',
    venueName: 'Plantation Cove',
    location: 'Plantation Cove, Priory, St. Ann, Jamaica',
