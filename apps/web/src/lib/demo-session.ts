...
const demoGuides: Record<DemoRole, DemoGuide> = {
  ...
  creator: {
    label: "Creator Demo",
    headline: "Show how creators publish a Release, then attach a room or perk.",
    summary: "Use this to frame Promorang as origin plus consequence, not a mission gig board.",
    primaryHref: "/content-drops",
    primaryLabel: "Open Releases",
    steps: [
      {
        id: "missions",
        title: "Browse Releases",
        description: "Start with live songs, stories, and episodes. The original stays off-platform.",
        href: "/content-drops",
        matchers: [exact("/content-drops"), exact("/watch-unlock")],
      },
      {
        id: "mission-detail",
        title: "Open a Release",
        description: "Show listen/read/watch, then the room or perk that catches it.",
        href: "/content-drops",
        matchers: [prefix("/content-drops/"), prefix("/watch-unlock/")],
      },
      {
