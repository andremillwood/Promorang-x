...
describe("localization", () => {
  ...
  it("covers dashboard, footer, discover, vault, nodes, wallet, and acquisition chrome", () => {
    const required = [
      ...
      "auditLed.empty",
      "lmQz.scene.title",
      "lmQz.scene.energy.new",
      "lmQz.sponsor.cta",
      "leadMagnet.participant.badge",
      "tax.venue.food_beverage",
      "tax.proof.screenshot",
      "archXtra.scout.example",
      "camCons.open_to_camera",
      "missRail.join",
      "catDlg.save",
      "arlaHub.seoTitle",
      "momentCard.checkIn",
      "momSect.exampleTitle",
      "demoBanner.homeTitle",
      "shareBtn.title",
      "exploreMom.seoTitle",
      "headerMenu.workspaces",
      "createMom.publish",
      "creatorsHub.hero1",
      "momentDetail.rsvpOpen",
    ] as const;
