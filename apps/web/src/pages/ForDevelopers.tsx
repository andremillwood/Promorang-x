...
if (call) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        title="Promorang Developer Platform & Model Context Protocol (MCP)"
        description="Build headless integrations, AI agents, bots, and apps powered by Promorang's promotion feed, coupon claiming engine, and merchant live-ops."
        type="website"
      />
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-xs font-semibold text-primary animate-pulse">
              ...
              <span>Agent-Ready • Model Context Protocol (MCP) • Headless SDK</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight">
              Build on the <span className="bg-gradient-to-r from-cyan-400 via-primary to-violet-400 bg-clip-text text-transparent">Real-World Growth Engine</span>
            </h1>

            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Connect external apps, autonomous AI agents, and chat bots directly to Promorang promotions, coupon drops, merchant operations, and creator rewards.
            </p>
      ...
      <section className="py-20 border-b border-border/40">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <h2 className="text-3xl font-bold tracking-tight">How Developers & Agents Connect</h2>
            <p className="text-muted-foreground">Four flexible integration pathways designed for modern software and LLM stacks.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-card/40 border-border/60 backdrop-blur-sm hover:border-cyan-500/40 transition-colors">
              <CardHeader className="space-y-2">
                ...
                <CardDescription>
                  Plug Promorang into Claude Desktop, Cursor, or Antigravity with 0 lines of custom code.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-card/40 border-border/60 backdrop-blur-sm hover:border-primary/40 transition-colors">
              <CardHeader className="space-y-2">
                ...
                <CardTitle className="text-lg">Headless TypeScript SDK</CardTitle>
                <CardDescription>
                  Zero-browser client (`@promorang/sdk`) for Node, Bun, Deno, bots, and backend microservices.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-card/40 border-border/60 backdrop-blur-sm hover:border-violet-500/40 transition-colors">
              <CardHeader className="space-y-2">
                ...
                <CardTitle className="text-lg">OpenAI & LangChain Tools</CardTitle>
                <CardDescription>
                  Native tool descriptors ready for OpenAI function calling, CrewAI, and LangGraph pipelines.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-card/40 border-border/60 backdrop-blur-sm hover:border-emerald-500/40 transition-colors">
              <CardHeader className="space-y-2">
                ...
                <CardTitle className="text-lg">REST & Webhooks</CardTitle>
                <CardDescription>
                  Standard HTTPS `/api/v1` routes authenticated with scoped API keys and rate limiters.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section id="quickstart" className="py-20 border-b border-border/40 bg-charcoal/30">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
            ...
            <h2 className="text-3xl font-bold tracking-tight">One Engine, Infinite Interfaces</h2>
            <p className="text-muted-foreground">Select your stack to view implementation code and configuration snippets.</p>
          </div>

          <div className="max-w-4xl mx-auto">
            <Tabs defaultValue="mcp" className="w-full">
              <TabsList className="grid grid-cols-4 w-full bg-card/60 p-1 rounded-xl border border-border/60">
                <TabsTrigger value="mcp" className="rounded-lg">MCP Server</TabsTrigger>
                <TabsTrigger value="sdk" className="rounded-lg">TypeScript SDK</TabsTrigger>
                <TabsTrigger value="openai" className="rounded-lg">OpenAI Tools</TabsTrigger>
                <TabsTrigger value="rest" className="rounded-lg">cURL / REST</TabsTrigger>
              </TabsList>
                ...
                <Card className="bg-card/90 border-border/80 shadow-2xl relative overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-3 border-b border-border/60 bg-muted/40">
                    ...
                    >
                      ...
                      {copiedTab === "mcp" ? "Copied" : "Copy Config"}
                    </Button>
                  </div>
                ...
                <Card className="bg-card/90 border-border/80 shadow-2xl relative overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-3 border-b border-border/60 bg-muted/40">
                    ...
                    >
                      ...
                      {copiedTab === "sdk" ? "Copied" : "Copy Code"}
                    </Button>
                  </div>
                ...
                <Card className="bg-card/90 border-border/80 shadow-2xl relative overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-3 border-b border-border/60 bg-muted/40">
                    ...
                    >
                      ...
                      {copiedTab === "openai" ? "Copied" : "Copy Code"}
                    </Button>
                  </div>
                ...
                <Card className="bg-card/90 border-border/80 shadow-2xl relative overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-3 border-b border-border/60 bg-muted/40">
                    ...
                    >
                      ...
                      {copiedTab === "rest" ? "Copied" : "Copy Command"}
                    </Button>
                  </div>
