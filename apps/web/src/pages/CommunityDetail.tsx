...
export default function CommunityDetail() {
  ...
  return (
    <main className="marketing-cinematic public-object-page min-h-screen bg-black pb-24 text-white">
      ...
      <nav className="public-object-tabs border-b border-white/10 bg-black/92 px-6"><div className="container flex gap-7 overflow-x-auto py-4 text-[10px] font-black uppercase tracking-[.12em] text-white/48"><a href="#scene-about" className="text-primary">About</a>{moments.length ? <a href="#scene-moments">Moments</a> : null}{discoveries.length ? <a href="#scene-discoveries">Discoveries</a> : null}<a href="#scene-join">Join</a></div></nav>\n      <section id="scene-about" className="container px-6 py-14 sm:py-20">
