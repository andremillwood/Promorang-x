...
export default function PioneerPoints() {
  ...
  return (
    <main className="min-h-screen bg-[#070707] pb-20 text-white">
      <SEO title="Pioneer Points — Promorang" description="Your verified contribution to the Promorang Genesis Season." />
      <section className="border-b border-white/10 pt-28">
        <div className="container px-6 pb-14">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-white/60">
            Pioneer Points record the verified work of members, creators, hosts, venues, and connectors building Promorang from the beginning.
          </p>
        </div>
      </section>
          ...
          <>
            <section className="grid gap-4 md:grid-cols-3">
              <div className="rounded-3xl border border-primary/30 bg-primary/[0.08] p-6 md:col-span-2">
                <div className="flex items-center gap-2 text-primary"><Sparkles className="h-5 w-5" /><span className="text-xs font-black uppercase tracking-widest">Verified Pioneer Points</span></div>
                <p className="mt-6 text-6xl font-black tracking-[-0.06em]">{Number(total.verified_points).toLocaleString()}</p>
                <p className="mt-3 text-sm text-white/50">Your confirmed share of contribution—not cash, equity, or a guaranteed payout.</p>
              </div>
            ...
            <section className="mt-8">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                ...
                )) : <div className="rounded-2xl border border-dashed border-white/15 p-6 md:col-span-2 lg:col-span-3"><p className="font-black">Your record begins with one useful move.</p><p className="mt-2 text-sm text-white/45">Choose an action below. Once proof is recorded, it will appear here as pending or verified.</p></div>}
              </div>
            </section>
            ...
            <section className="mt-8 grid gap-4 lg:grid-cols-2">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6">
                ...
                <p className="mt-4 text-sm leading-6 text-white/55">
                  If Promorang establishes a funded Founding Reward Pool, verified Pioneer Points may be considered under the announced snapshot, eligibility, fraud review, and allocation terms.
                </p>
            ...
            <section className="mt-8 rounded-3xl border border-white/10 bg-white/[0.025] p-6">
              <div className="flex items-center justify-between"><div><p className="text-[10px] font-black uppercase tracking-[0.22em] text-primary">Proof receipts</p><h2 className="mt-1 text-2xl font-black">Your contribution trail</h2></div><CircleDot className="h-5 w-5 text-primary" /></div>
            ...
            {!!data.venues?.length && <section className="mt-8">
              <div><p className="text-[10px] font-black uppercase tracking-[0.22em] text-primary">Places you operate</p><h2 className="mt-1 text-2xl font-black">Venue Pioneer records</h2></div>
