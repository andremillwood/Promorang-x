          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col items-stretch justify-center gap-4 sm:flex-row sm:items-center">
              <Button variant="hero" size="xl" asChild>
                <Link to={authEntryHref({ role: "creator", mode: "signup", next: "/content-drops" })}>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[3rem] border border-white/10 bg-white/5 p-8 md:p-12">
                ...
                <Button variant="hero" size="lg" className="mt-8 w-full" asChild>
                  <Link to={authEntryHref({ role: "creator", mode: "signup", next: "/content-drops" })}>{t("forCreators.openStudio")}</Link>
                </Button>
              </div>
            </div>
          </div>
