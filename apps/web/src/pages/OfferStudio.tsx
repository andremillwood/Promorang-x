...
const activationTemplates = [
  ...
  },
  {
    ...
    icon: Gift,
    form: {
      title: "Gift extra places",
      description: "A guest holds extra spots and sends them. Each gifted place becomes its own pass at the door.",
      terms: "Extra places count against capacity. The holder sends the private link. One redemption per gifted guest.",
      reward_type: "access",
      fulfillment_type: "merchant_validation",
      value_amount: "0",
      value_currency: "JMD",
  ...
  },
  {
    ...
    roles: ["merchant", "host", "brand", "admin"],
    quickTitleKey: "offerStudio.template6Quick" as TranslationKey,
    titleKey: "offerStudio.template6Title" as TranslationKey,
    goalKey: "offerStudio.template6Goal" as TranslationKey,
    bestForKey: "offerStudio.template6BestFor" as TranslationKey,
    icon: Sparkles,
    form: {
      title: "Seasonal counter drop",
      description: "A limited perk on the guest pass for this season — visible before they arrive.",
      terms: "Valid during the published seasonal window only. Inventory is finite. Scan at the counter.",
      reward_type: "experience",
      fulfillment_type: "merchant_validation",
      value_amount: "15",
      value_currency: "JMD",
  ...
  {
    id: "entry-upgrade-premium",
    roles: ["merchant", "host", "brand", "admin"],
    quickTitleKey: "offerStudio.template7Quick" as TranslationKey,
    titleKey: "offerStudio.template7Title" as TranslationKey,
    goalKey: "offerStudio.template7Goal" as TranslationKey,
    bestForKey: "offerStudio.template7BestFor" as TranslationKey,
    icon: Ticket,
    form: {
      title: "Entry, upgrade, premium",
      description: "Three ways into the night, printed on the guest object: walk-in, upgrade, and the room upstairs.",
      terms: "Each tier is a separate pass. Upgrades require the entry pass first. Premium is capacity-capped.",
      reward_type: "access",
      fulfillment_type: "merchant_validation",
      value_amount: "25",
      value_currency: "JMD",
