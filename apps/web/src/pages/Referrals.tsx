    ...
    <main className="min-h-screen bg-[#080808] text-white">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <header className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.035] px-6 py-8 sm:px-8">
          ...
          <div className="relative">
            ...
            <h1 className="max-w-3xl text-4xl font-black tracking-tight sm:text-6xl">
              Invite people. Build the culture together.
            </h1>
            <p className="mt-4 max-w-2xl text-sm leading-6 text-white/65 sm:text-base">
              Share your personal link and follow the people who join Promorang through you.
            </p>
            <div className="mt-6 flex flex-wrap gap-x-6 gap-y-2 text-xs font-medium text-white/55">
              <span className="inline-flex items-center gap-2"><Link2 className="h-4 w-4 text-[#FF6A00]" /> One link tied to your account</span>
              <span className="inline-flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-[#FF6A00]" /> Qualified activity is verified</span>
            </div>
          </div>
        </header>
        ...
        <section aria-labelledby="referral-dashboard-title" className="mt-8">
          <div className="mb-4">
            <p className="text-xs font-black uppercase tracking-[0.22em] text-[#FF6A00]">Referral dashboard</p>
            <h2 id="referral-dashboard-title" className="mt-1 text-2xl font-black">Your links and results</h2>
          </div>
          <ReferralsSection />
        </section>
      </div>
