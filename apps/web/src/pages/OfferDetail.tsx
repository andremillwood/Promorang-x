...
export default function OfferDetail() {
  ...
  return <main className="marketing-cinematic public-object-page min-h-screen bg-[#050505] text-white">
    ...
    <section className="border-t border-white/10 bg-white/[.02] px-5 py-10 sm:px-6"><div className="mx-auto flex max-w-[1080px] flex-col gap-5 sm:flex-row sm:items-center sm:justify-between"><div><p className="flex items-center gap-2 text-[9px] font-black uppercase tracking-[.15em] text-orange-300"><WalletCards className="h-3.5 w-3.5"/>PromoCard</p><h2 className="mt-2 text-2xl font-black">Claim it. Keep it close.</h2></div><button type="button" disabled={!!actions.busy} onClick={authClaim} className="inline-flex min-h-11 items-center gap-2 border border-orange-400/40 px-5 text-xs font-black uppercase tracking-[.08em] text-orange-300 disabled:opacity-50">Claim Offer <ArrowRight className="h-4 w-4"/></button></div></section>
  </main>;
}
