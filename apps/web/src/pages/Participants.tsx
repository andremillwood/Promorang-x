        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <div className="relative flex-1">
                    ...
                    <Input placeholder={t("participantsPage.searchPlaceholder")} className="pl-10" />
                </div>
                <Button variant="outline" className="w-full sm:w-auto">{t("participantsPage.filter")}</Button>
            </div>
                ...
                <Table>
                    <TableHeader className="bg-muted/30">
                        <TableRow>
                            ...
                            <TableHead>{t("participantsPage.thContact")}</TableHead>
                            <TableHead>{t("participantsPage.thRank")}</TableHead>
                            <TableHead>{t("participantsPage.thStatus")}</TableHead>
                            <TableHead>{t("participantsPage.thJoinedDate")}</TableHead>
                            <TableHead className="text-right">{t("participantsPage.thActions")}</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                            ...
                            <TableRow key={participant.id} className="hover:bg-muted/20">
                                ...
                                <TableCell>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="font-medium">{t("participantsPage.level", { rank: participant.rank.toString() })}</span>
                                    </div>
                                </TableCell>
                                <TableCell>
                                ...
                                <TableCell className="text-right">
                                    <Button variant="ghost" size="sm">{t("participantsPage.details")}</Button>
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                    ...
                    {mockParticipants.map((participant) => (
                        <div key={participant.id} className="rounded-xl border border-border bg-background/50 p-4">
                            ...
                            <div className="mt-3 grid grid-cols-2 gap-3 text-sm">
                                <div>
                                    <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">{t("participantsPage.consistencyLabel")}</p>
                                ...
                                <div>
                                    <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">{t("participantsPage.joinedLabel")}</p>
                                    <p className="mt-1 text-foreground">{participant.joinedDate}</p>
                                </div>
                            </div>
                            <Button variant="ghost" size="sm" className="mt-3 w-full">{t("participantsPage.details")}</Button>
                        </div>
                    ))}
                </div>
            </div>
