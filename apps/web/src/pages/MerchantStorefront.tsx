...
export default function MerchantStorefront() {
  ...
  return <main className="marketing-cinematic merchant-public-world min-h-screen bg-[#050505] text-white">
    ...
    <nav className="public-object-tabs border-b border-white/10 bg-black/92 px-5 sm:px-6"><div className="mx-auto flex max-w-[1320px] gap-7 overflow-x-auto py-4 text-[10px] font-black uppercase tracking-[.12em] text-white/48"><a href="#available" className="text-orange-300">Available</a>{offers.length?<a href="#offers">Perks</a>:null}{services.length?<a href="#services">Book</a>:null}{products.length?<a href="#products">Products</a>:null}</div></nav>
