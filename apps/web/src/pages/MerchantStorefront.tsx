...
export default function MerchantStorefront() {
  ...
  if(q.isError) return <main className="grid min-h-screen place-items-center bg-[#050505] px-6 text-center text-white"><div><Store className="mx-auto h-8 w-8 text-orange-400"/><h1 className="mt-4 text-4xl font-black">Storefront unavailable.</h1><p className="mt-3 text-sm text-white/45">We couldn’t load this storefront right now.</p></div></main>;
  if(!merchant) return <main className="grid min-h-screen place-items-center bg-[#050505] px-6 text-center text-white"><div><Store className="mx-auto h-8 w-8 text-orange-400"/><h1 className="mt-4 text-4xl font-black">Nothing public here yet.</h1><p className="mt-3 text-sm text-white/45">This merchant hasn’t put anything public here yet.</p></div></main>;
  ...
  return <main className="marketing-cinematic merchant-public-world min-h-screen bg-[#050505] text-white">
    ...
    <section className="border-t border-white/10 bg-[#090909] px-5 py-12 sm:px-6"><div className="mx-auto flex max-w-[1120px] flex-col gap-5 sm:flex-row sm:items-center sm:justify-between"><div><p className="text-[9px] font-black uppercase tracking-[.15em] text-orange-300">Merchant on PROMORANG</p><h2 className="mt-2 text-2xl font-black">Come back when something changes.</h2><p className="mt-2 text-xs text-white/42">Nothing new here right now. Keep exploring and come back when this merchant adds something.</p></div><Link to="/discover" className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[.08em] text-orange-300">Keep exploring <ArrowRight className="h-4 w-4"/></Link></div></section>
  </main>;
}
