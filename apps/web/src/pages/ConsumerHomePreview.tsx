...
const featuredMoment: MomentObject = {
  id: "preview-ilhh",
  kind: "moment",
...
const ConsumerHomePreview = () => {
  return (
    <ConsumerShell
      ...
      actions={<div className="grid h-9 w-9 place-items-center rounded-full bg-foreground text-xs font-black text-background">A</div>}
    >
      <section className="pb-7 pt-2 md:pb-10 md:pt-6">
        <p className="text-[11px] font-black uppercase tracking-[0.16em] text-primary">Monday evening · Kingston</p>
        <h1 className="mt-2 max-w-4xl font-serif text-4xl font-semibold leading-[0.98] tracking-[-0.045em] sm:text-5xl lg:text-7xl">
          Your Promorang should start with what matters now.
        </h1>
      ...
      <section className="grid gap-8 lg:grid-cols-[minmax(0,1.55fr)_minmax(320px,.7fr)] lg:gap-10">
        ...
        <aside className="space-y-6">
          ...
          <section className="border-t border-border pt-5">
            ...
            <p className="mt-4 text-sm leading-6 text-muted-foreground">1 active access perk · 2 verified actions this week.</p>
          </section>
        </aside>
      </section>
    </ConsumerShell>
