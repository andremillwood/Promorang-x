...
const audiences = [
  {
    ...
    subtitle: "Turn useful participation into recorded access, perks, and history",
    icon: Users,
    color: "from-amber-500/20 to-orange-500/10 border-amber-500/30 text-amber-400",
    badge: "Locals & Explorers",
    points: [
      "Vote on discoveries and polls so the city names the night.",
      "Share it with PromoShare. When downstream action is verified and attributed, that contribution can be recorded.",
      "Walk in with PromoCard. Check in or submit the required proof; verified attendance can become part of your history.",
      "Keep the access, memories, entries, or other consequences that were actually issued, and build a durable participation history.",
    ],
    cta: "Start Exploring",
    href: "/discover",
  },
  {
    ...
    subtitle: "Turn demand into verifiable visits and repeat behavior",
    icon: Building2,
    color: "from-emerald-500/20 to-teal-500/10 border-emerald-500/30 text-emerald-400",
    badge: "Restaurants, Cafes & Bars",
    points: [
      "See recorded local demand and activation opportunities that may be relevant to your place.",
      "Verify eligible visits with QR, check-in, or proof rules configured for the activation.",
      "Structure funding or commercial terms around recorded outcomes where the activation contract supports it.",
      "Use recorded visits, redemptions, and return behavior to shape the next offer or activation.",
    ],
  ...
  },
  {
    ...
    subtitle: "Connect distribution to attributable real-world outcomes",
    icon: Sparkles,
    color: "from-purple-500/20 to-pink-500/10 border-purple-500/30 text-purple-400",
    badge: "Content Creators & Hosts",
    points: [
      "Join configured creator opportunities and briefs when they are available and relevant.",
      "Host your own activations and seek sponsorship or funding where a real partner commitment exists.",
      "Earnings follow only when campaign terms, attribution, verification, approval, and settlement support them.",
      "Build a reusable record of releases, attributed outcomes, approved work, and retained value.",
    ],
  ...
  },
  {
    ...
    points: [
      "Fund activations, participant value, or demand tests around a defined audience and outcome.",
      "Review GPS, receipt, check-in, or other proof where that evidence is configured and actually recorded.",
      "Invite creator and participant content, then retain only the UGC and recommendations that are actually produced and attributable.",
      "Add recorded real-world action evidence to campaigns that would otherwise rely mainly on impressions.",
    ],
    cta: "Brand Solutions",
    href: "/for-brands",
  },
