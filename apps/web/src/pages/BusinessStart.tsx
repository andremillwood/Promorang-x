    ...
    <main className="marketing-cinematic min-h-screen overflow-x-clip bg-[#060606] text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10 px-5 pb-12 pt-24 sm:px-6 md:pb-16 md:pt-32">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-white/60">You do not need to arrive knowing whether the answer is commerce, an Offer, a Moment, distribution or a demand test. Tell PROMORANG what needs to improve and we will help construct a measurable route.</p>
          <div className="mt-7 flex flex-wrap gap-4 text-xs font-bold">
            <Link to="/#wanted" className="inline-flex items-center gap-2 text-orange-300">Show me what people want <ArrowRight className="h-4 w-4" /></Link>
