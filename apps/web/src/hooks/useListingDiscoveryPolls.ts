  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return ((data || []) as ListingPollRow[]).map((row): DiscoveryPoll => ({
        ...
        purpose: "verdict",
        purposeLabel: "Help verify this place",
        consequence: "Your answer helps PROMORANG and the community keep this mapped place accurate.",
        decisionOwner: "PROMORANG / community",
