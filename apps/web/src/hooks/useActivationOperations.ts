...
export function useActivationOperations(proposalId: string) {
  ...
  const outcomeStakeholderType = ["creator", "host", "merchant", "brand", "agency"].includes(activeRole || "")
    ? activeRole
    : null;
