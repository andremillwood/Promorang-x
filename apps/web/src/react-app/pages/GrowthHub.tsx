    ...
    <div className="space-y-8">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-8">
          ...
          <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
            <h3 className="text-lg font-semibold text-pr-text-1 mb-6">Your Active Positions</h3>
            {stakingPositions.length > 0 ? (
                    ...
                    <div key={position.id} className="bg-pr-surface-2 rounded-lg p-4 border border-pr-border">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h4 className="font-semibold text-pr-text-1">{channel?.name}</h4>
                            <p className="text-sm text-pr-text-2">{position.amount} Gems staked</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-lg font-bold text-green-600">+{position.earnedSoFar} Gems</div>
                          <div className="text-sm text-pr-text-2">{daysLeft} days left</div>
                        </div>
                      </div>
                      <div className="mt-4">
                        <div className="flex items-center justify-between text-sm text-pr-text-2 mb-2">
                          <span>Progress</span>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-pr-text-1 mb-2">No Active Positions</h3>
                <p className="text-pr-text-2 mb-6">Start growing your gems through our staking channels</p>
                <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-pr-text-1">Platform Growth</h3>
                  <p className="text-sm text-pr-text-2">Last 30 days</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-pr-text-2">Total Staked</span>
                  <span className="font-semibold">{totalEconomicValue.toLocaleString()} Gems</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-pr-text-2">Active Stakers</span>
                  <span className="font-semibold">{totalStakers.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-pr-text-2">Avg APR</span>
            ...
            <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-pr-text-1">Creator Funding</h3>
                  <p className="text-sm text-pr-text-2">Active projects</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-pr-text-2">Live Projects</span>
                  <span className="font-semibold">{fundingProjects.length}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-pr-text-2">Total Funding</span>
                  <span className="font-semibold">${fundingProjects.reduce((sum, p) => sum + p.currentFunding, 0).toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-pr-text-2">Success Rate</span>
            ...
            <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-pr-text-1">Social Shield</h3>
                  <p className="text-sm text-pr-text-2">Protection status</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-pr-text-2">Coverage Level</span>
                  <span className="font-semibold">Pro Shield</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-pr-text-2">Max Coverage</span>
      ...
      {activeTab === 'channels' && (
        <div className="space-y-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-pr-text-1">Growth Channels</h2>
              <p className="text-pr-text-2">Lock your gems for higher multipliers and platform rewards</p>
            </div>
            <div className="text-right">
              <div className="text-sm text-pr-text-2">Your Available Balance</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {displayedGrowthChannels.map((channel) => {
              ...
              return (
                <div key={channel.id} className="bg-pr-surface-card rounded-xl border border-pr-surface-3 shadow-sm overflow-hidden hover:shadow-md transition-all duration-200">
                  <div className={`bg-gradient-to-r ${getChannelColor(channel.color)} p-6 text-white`}>
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-pr-surface-card/20 rounded-xl flex items-center justify-center">
                          <Icon className="w-6 h-6" />
                        </div>
                        <div>
                          <h3 className="text-xl font-bold">{channel.name}</h3>
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${getRiskColor(channel.riskLevel)} text-pr-text-1`}>
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div>
                        <div className="text-sm text-pr-text-2">Lock Period</div>
                        <div className="font-semibold">{channel.lockPeriod} days</div>
                      </div>
                      <div>
                        <div className="text-sm text-pr-text-2">Multiplier</div>
                        <div className="font-semibold">{channel.baseMultiplier}x</div>
                      </div>
                      <div>
                        <div className="text-sm text-pr-text-2">Min Deposit</div>
                        <div className="font-semibold">{channel.minDeposit} Gems</div>
                      </div>
                      <div>
                        <div className="text-sm text-pr-text-2">Participants</div>
                        <div className="font-semibold">{channel.participantCount}</div>
                      </div>
                    </div>

                    <div className="mb-6">
                      <div className="text-sm text-pr-text-2 mb-2">Features</div>
                      <div className="space-y-1">
                        {channel.features.map((feature, index) => (
                          <div key={index} className="flex items-center space-x-2">
                            <CheckCircle className="w-4 h-4 text-green-600" />
                            <span className="text-sm text-pr-text-1">{feature}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="bg-pr-surface-2 rounded-lg p-4">
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-pr-text-2">Total Deposited</span>
          ...
          <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-pr-text-1">Staking Calculator</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-pr-text-1 mb-2">Channel</label>
                <select className="w-full px-3 py-2 border border-pr-surface-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                  {displayedGrowthChannels.map(channel => (
              ...
              <div>
                <label className="block text-sm font-medium text-pr-text-1 mb-2">Estimated Rewards</label>
                <div className="px-3 py-2 bg-green-50 border border-green-200 rounded-lg text-green-800 font-medium">
                  +250 Gems
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-pr-text-1 mb-2">Total Return</label>
      ...
      {activeTab === 'funding' && (
        <div className="space-y-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-pr-text-1">Creator Funding</h2>
              <p className="text-pr-text-2">Support innovative projects and earn from their success</p>
            </div>
            <button
          ...
          <div className="space-y-6">
            {fundingProjects.filter(p => p.featured).map((project) => (
              <div key={project.id} className="bg-pr-surface-card rounded-xl border border-pr-surface-3 shadow-sm overflow-hidden">
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 border-b border-pr-surface-3">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-pr-text-1 mb-2">{project.title}</h3>
                      ...
                      <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <span className="font-medium text-pr-text-1">{project.creatorName}</span>
                        </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-6">
                      <div className="text-center">
                        <div className="text-lg font-bold text-pr-text-1">{project.backerCount}</div>
                        <div className="text-sm text-pr-text-2">Backers</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-bold text-pr-text-1">{project.daysLeft}</div>
                        <div className="text-sm text-pr-text-2">Days Left</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-bold text-green-600">
                          {((project.currentFunding / project.fundingGoal) * 100).toFixed(0)}%
                        </div>
                        <div className="text-sm text-pr-text-2">Funded</div>
                      </div>
                    </div>
                    <button
                      onClick={() => {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {project.rewardTiers.slice(0, 3).map((tier, index) => (
                      <div key={index} className="border border-pr-surface-3 rounded-lg p-4">
                        <div className="text-lg font-bold text-pr-text-1 mb-2">${tier.amount}</div>
                        <h4 className="font-semibold text-pr-text-1 mb-2">{tier.title}</h4>
                        <p className="text-sm text-pr-text-2 mb-3">{tier.description}</p>
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-pr-text-2">{tier.backerCount} backers</span>
              ...
              <div key={project.id} className="bg-pr-surface-card rounded-xl border border-pr-surface-3 shadow-sm overflow-hidden hover:shadow-md transition-all duration-200">
                <div className="p-6">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    />
                    <div>
                      <h4 className="font-semibold text-pr-text-1">{project.creatorName}</h4>
      ...
      {activeTab === 'shield' && (
        <div className="space-y-8">
          <div>
            <h2 className="text-2xl font-bold text-pr-text-1 mb-2">Social Shield</h2>
            <p className="text-pr-text-2">Protect your social media earnings with comprehensive insurance coverage</p>
          </div>
              ...
              <div key={policy.id} className={`bg-pr-surface-card rounded-xl border-2 shadow-sm overflow-hidden ${policy.id === 'pro' ? 'border-blue-500 ring-2 ring-blue-100' : 'border-pr-surface-3'
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                      <h4 className="font-semibold text-pr-text-1 mb-2">Coverage Includes:</h4>
                      <ul className="space-y-2">
                        {Object.entries(policy.coverage).map(([key, covered]) => (
                          <li key={key} className="flex items-center space-x-2">
                            ...
                            <span className={`text-sm ${covered ? 'text-pr-text-1' : 'text-gray-400'}`}>
          ...
          <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
            <h3 className="text-lg font-semibold text-pr-text-1 mb-4">Recent Claims</h3>
            <div className="text-center py-8 text-pr-text-2">
      ...
      {activeTab === 'economy' && (
        <div className="space-y-8">
          <div>
            <h2 className="text-2xl font-bold text-pr-text-1 mb-2">Platform Economy</h2>
            <p className="text-pr-text-2">How your participation drives the entire Promorang ecosystem</p>
          </div>
            ...
            <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
              ...
              <div className="flex justify-center space-x-6 mt-4 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-pr-text-2">Rewards Distributed</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                  <span className="text-pr-text-2">Funding Volume</span>
                </div>
              </div>
            </div>

            <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
              <h3 className="text-lg font-semibold text-pr-text-1 mb-6">Value Distribution</h3>
              <ActivityBreakdown
                data={[
          ...
          <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
            <h3 className="text-lg font-semibold text-pr-text-1 mb-6">How Growth Hub Stimulates the Economy</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-pr-text-1">Staking Creates Liquidity</h4>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-pr-text-1">Funding Drives Innovation</h4>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-pr-text-1">Shield Stabilizes Earnings</h4>
                    <p className="text-pr-text-2 text-sm">Social Shield premiums create a safety net that encourages more users to participate confidently.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-pr-text-1">Network Effects</h4>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-pr-text-1">Value Alignment</h4>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-pr-text-1">Continuous Innovation</h4>
                    <p className="text-pr-text-2 text-sm">Funds from Growth Hub activities are reinvested into new earning opportunities and platform improvements.</p>
                  </div>
                </div>
              </div>
            </div>
