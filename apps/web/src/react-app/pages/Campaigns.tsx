      ...
      <div className="bg-pr-surface-card shadow overflow-hidden sm:rounded-lg">
        {campaigns.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-lg font-medium text-pr-text-1">No campaigns</h3>
            <p className="mt-1 text-sm text-pr-text-2">
          ...
          <ul className="divide-y divide-gray-200">
            {campaigns.map((campaign) => (
              <li key={campaign.id} className="hover:bg-pr-surface-2">
                  ...
                  <div className="px-4 py-4 sm:px-6">
                    ...
                    {campaign.status !== 'draft' && (
                      <div className="mt-2">
                        ...
                        <div className="mt-1 w-full bg-pr-surface-3 rounded-full h-2">
                          <div 
