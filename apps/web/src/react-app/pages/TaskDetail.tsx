  ...
  if (!drop) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-bold text-pr-text-1 mb-4">Drop not found</h2>
        <button 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-pr-surface-2 rounded-lg p-4 mb-4 border border-pr-surface-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium border ${
                    masterKeyStatus.is_activated ? 'text-green-400 border-green-500/60 bg-pr-surface-1' : 'text-orange-400 border-orange-500/60 bg-pr-surface-1'
                  }`}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-blue-50 rounded-lg p-3">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className="text-sm font-medium text-pr-text-1">Keys</span>
                  </div>
                ...
                <div className="bg-pr-surface-2 rounded-lg p-3">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className="text-sm font-medium text-pr-text-1">Gems</span>
                  </div>
                  <p className="text-xl font-bold text-pr-text-1">{userData.gems_balance}</p>
                </div>
              </div>
          ...
          {application ? (
            <div className="bg-pr-surface-card rounded-xl border border-pr-surface-3 p-6">
              ...
              <div className="bg-pr-surface-2 rounded-lg p-4 mb-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-pr-text-2">Keys Used</span>
            ...
            <div className="bg-pr-surface-card rounded-xl border border-pr-surface-3 p-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-pr-text-1">Apply for this Drop</h3>
              </div>
              ...
              {userData && (userData.keys_balance < drop.key_cost || !masterKeyStatus?.is_activated) && (
                <div className="mb-4 p-4 bg-pr-surface-2 border border-yellow-500/60 rounded-lg">
                  <h4 className="font-medium text-pr-text-1 mb-2">Requirements not met:</h4>
              ...
              <form onSubmit={handleApply} className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 border border-pr-surface-3 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-pr-surface-card rounded-xl border border-pr-surface-3 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <Key className="w-4 h-4 text-orange-600" />
                  <span className="text-pr-text-2">Key Cost</span>
                </div>
          ...
          <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3">
            ...
            />
            <div className="mt-2">
              <p className="text-sm text-pr-text-2">Verified creator</p>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-pr-surface-3">
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  ...
                  <p className="text-xs text-pr-text-2">Drops Posted</p>
                </div>
                <div>
