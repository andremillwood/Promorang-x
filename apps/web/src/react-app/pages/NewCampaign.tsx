        ...
        <div className="space-y-8">
          ...
          {calculatedCost !== null && (
            <div className={cn(
              ...
              {moveCost && (
                <div className="mt-3 pt-3 border-t border-pr-surface-3 text-xs text-pr-text-2">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-pr-text-2">Basic information about your campaign</p>
            </div>
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div className="space-y-2">
                  <label htmlFor="campaignType" className="block text-sm font-medium text-pr-text-1">
                    Campaign Type
                  </label>
                  <Select
                        ...
                        <SelectItem key={type.value} value={type.value}>
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <div className="text-xs text-pr-text-2">{type.description}</div>
                            </div>
                            <div className="text-sm text-pr-text-2">{type.cost}</div>
                          </div>
                        </SelectItem>
                      ))}
                    </SelectContent>
                ...
                <div className="space-y-2">
                  <label htmlFor="audienceSize" className="block text-sm font-medium text-pr-text-1">
                ...
                <div className="space-y-2">
                  <label htmlFor="name" className="block text-sm font-medium text-pr-text-1">
                    Campaign Name
                  </label>
                  <Input
                    type="text"
                ...
                <div className="sm:col-span-4">
                  <label htmlFor="objective" className="block text-sm font-medium text-pr-text-1">
                    Campaign Objective
                  </label>
                  <div className="mt-1">
                    <Select
                ...
                <div className="sm:col-span-6">
                  <label htmlFor="description" className="block text-sm font-medium text-pr-text-1">
            ...
            <div className="bg-pr-surface-card shadow sm:rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg font-medium leading-6 text-pr-text-1">Schedule & Budget</h3>
                ...
                <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-3">
                    <label htmlFor="budget" className="block text-sm font-medium text-pr-text-1">
                      Total Budget ($)
                    </label>
                  ...
                  <div className="sm:col-span-3">
                    <label htmlFor="dailyBudget" className="block text-sm font-medium text-pr-text-1">
                      Daily Budget ($)
                    </label>
                    <div className="mt-1 relative rounded-md shadow-sm">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div className="bg-pr-surface-card shadow sm:rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg font-medium leading-6 text-pr-text-1">Bidding & Optimization</h3>
                <p className="mt-1 text-sm text-pr-text-2">
                  How you want to bid and optimize your campaign
                </p>
                <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  <div className="sm:col-span-3">
                    <label htmlFor="bidStrategy" className="block text-sm font-medium text-pr-text-1">
                      Bid Strategy
                    </label>
                    <div className="mt-1">
                      <Select
                  ...
                  {formData.bidStrategy !== 'lowest_cost' && (
                    <div className="sm:col-span-3">
                      <label htmlFor="bidAmount" className="block text-sm font-medium text-pr-text-1">
                  ...
                  <div className="sm:col-span-3">
                    <label htmlFor="targetCtr" className="block text-sm font-medium text-pr-text-1">
                      Target CTR (%)
                    </label>
                    <div className="mt-1 relative rounded-md shadow-sm">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  <div className="sm:col-span-3">
                    <label htmlFor="targetCpc" className="block text-sm font-medium text-pr-text-1">
                      Target CPC ($)
                    </label>
                    <div className="mt-1 relative rounded-md shadow-sm">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
