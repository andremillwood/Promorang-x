  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-pr-text-1">Earn</h1>
      ...
      {filteredDrops.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-pr-text-1 mb-2">No drops found</h3>
          <p className="text-pr-text-2">Try adjusting your search criteria or create a new drop.</p>
        </div>
      )}
...
function DropCard({ drop }: { drop: DropType }) {
  ...
  return (
    <div className="bg-pr-surface-card rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
      {/* Demo Banner */}
      {isDemo && (
      ...
      <div className="p-6">
        ...
        <h3 className="text-lg font-semibold text-pr-text-1 mb-2 cursor-pointer hover:text-orange-600 transition-colors" onClick={handleDropClick}>
          {drop.title}
        </h3>
        ...
        <div className="flex items-center justify-between">
          <span className={`text-sm text-pr-text-2 bg-pr-surface-2 px-3 py-1 rounded-full ${getDifficultyColor(drop.difficulty)}`}>
            {formatLabel(drop.drop_type)}
          </span>
          <div className="flex space-x-2">
            <button
              onClick={handleDropClick}
              className="bg-pr-surface-2 hover:bg-pr-surface-3 text-pr-text-1 px-4 py-2 rounded-lg text-sm font-medium transition-colors"
            >
              View Details
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {uploadMode === 'upload' ? (
              <div>
                ...
                <button
                  ...
                  className="w-full p-2 border-2 border-dashed border-pr-surface-3 rounded-md text-pr-text-2 hover:border-orange-500 hover:text-orange-500 transition-colors"
                >
          ...
          <div className="flex justify-end space-x-3 pt-4">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 border rounded-md text-pr-text-1 hover:bg-pr-surface-2"
              disabled={loading}
            >
              Cancel
            </button>
