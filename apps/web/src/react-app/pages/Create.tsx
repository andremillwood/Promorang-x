  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-pr-text-1">Create</h1>
          <p className="text-pr-text-2 mt-2">Share your content and unlock earning opportunities</p>
        </div>
        
        {/* Info about monetization */}
        <div className="text-right">
          <p className="text-sm text-pr-text-2">Need to create marketing campaigns?</p>
