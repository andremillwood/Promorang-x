...
export default function AdvertiserOnboarding() {
  ...
  // State 0/1 users see simplified onboarding unless they explicitly request full view
  ...
  return (
    <EntryLayout showBackToStart={true}>
      <div className="bg-gradient-to-br from-orange-50 via-red-50 to-purple-50 dark:from-orange-950/10 dark:via-red-950/10 dark:to-purple-950/10">
        {/* Hero Section */}
