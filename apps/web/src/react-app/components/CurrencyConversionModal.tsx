    ...
    >
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-pr-text-1">Convert Currency</h2>
          <button
            onClick={onClose}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <p className="text-sm text-pr-text-2">Balance: {user.points_balance}</p>
              ...
              >
                ...
                <p className="text-sm text-pr-text-2">Balance: {user.gems_balance}</p>
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                disabled={amount <= 1}
                className="w-8 h-8 bg-pr-surface-3 hover:bg-pr-surface-3 disabled:opacity-50 disabled:cursor-not-allowed rounded text-pr-text-1 font-bold"
              >
                -
              </button>
              <input
                ...
                min="1"
                className="flex-1 px-3 py-2 border border-pr-surface-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-center"
              />
              <button
                type="button"
                onClick={() => setAmount(amount + 1)}
                className="w-8 h-8 bg-pr-surface-3 hover:bg-pr-surface-3 rounded text-pr-text-1 font-bold"
              >
                +
              </button>
            </div>
            <div className="flex space-x-2 mt-2">
              {[1, 3, 5, 10].map((qty) => (
                <button
                  ...
                  className="px-3 py-1 text-xs bg-pr-surface-2 hover:bg-pr-surface-3 rounded-full text-pr-text-1"
                >
                  {qty} key{qty > 1 ? 's' : ''}
                </button>
              ))}
          ...
          <div className="bg-pr-surface-2 rounded-lg p-4">
            ...
            <div className="flex items-center justify-between text-sm text-pr-text-2 mt-2">
              <span>
