        ...
        <div className="border-b border-pr-surface-3 px-6 pt-6 pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-bold text-pr-text-1">Influence Rewards</h2>
            </div>
            <button
              onClick={onClose}
              className="rounded-lg p-2 text-gray-400 transition-colors hover:text-pr-text-2"
              aria-label="Close influence rewards modal"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6 pt-4">
          {step === 1 && (
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-pr-text-1 mb-2">Earn Points from Your Influence</h3>
            ...
            <div className="space-y-4">
              <h4 className="font-medium text-pr-text-1">Enter Your Information</h4>
          ...
          {step === 2 && rewardData && (
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-pr-text-1 mb-2">Registration Successful!</h3>
              <p className="text-pr-text-2 text-sm">
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-pr-text-1">Platform:</span>
                  <div className="flex items-center space-x-2">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full px-4 py-2 border border-pr-surface-3 rounded-lg text-pr-text-1 font-medium hover:bg-pr-surface-2 transition-colors"
              >
