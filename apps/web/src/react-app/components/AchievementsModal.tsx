...
export default function AchievementsModal({ user, isOpen, onClose }: AchievementsModalProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="-mx-6 -mt-6 bg-gradient-to-r from-yellow-500 to-orange-500 p-6 text-white">
      ...
      {/* Category Tabs */}
      <div className="-mx-6 border-b border-pr-surface-3 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredAchievements && filteredAchievements.length > 0 ? filteredAchievements.map((achievement) => (
              ...
              >
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-semibold text-pr-text-1">{achievement.name}</h3>
                ...
                {/* Locked Overlay */}
                {achievement.progress < achievement.criteria_value && !achievement.is_completed && (
                  <div className="absolute inset-0 bg-pr-surface-2 bg-opacity-50 rounded-2xl flex items-center justify-center">
              ...
              <div className="col-span-full text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-pr-text-1 mb-2">No Achievements Yet</h3>
                <p className="text-pr-text-2">Complete tasks and reach milestones to unlock achievements!</p>
              </div>
            )}
          </div>
        )}
