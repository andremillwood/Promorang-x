  ...
  return (
    ...
    >
      <div className="flex max-h-[85vh] flex-col overflow-hidden rounded-2xl">
        {/* Header */}
        <div className={`bg-gradient-to-r ${getChannelColor()} px-6 pt-6 pb-4 text-white`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <span className={`inline-block rounded-full px-2 py-1 text-xs font-medium ${getRiskColor()} text-pr-text-1`}>
          ...
          <p className="mt-4 text-white/90">{channel.description}</p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6 pt-4 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-3 bg-pr-surface-2 rounded-lg">
              <div className="text-lg font-bold text-pr-text-1">{channel.lockPeriod}</div>
              <div className="text-sm text-pr-text-2">Days Locked</div>
            </div>
            <div className="text-center p-3 bg-pr-surface-2 rounded-lg">
              <div className="text-lg font-bold text-green-600">{channel.expectedApr}%</div>
              <div className="text-sm text-pr-text-2">Expected APR</div>
            </div>
            <div className="text-center p-3 bg-pr-surface-2 rounded-lg">
            ...
            <div className="text-center p-3 bg-pr-surface-2 rounded-lg">
              ...
              <div className="text-sm text-pr-text-2">Your Balance</div>
            </div>
          </div>

          {/* Features */}
          <div>
            <h3 className="font-semibold text-pr-text-1 mb-3">Channel Features</h3>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 border border-pr-surface-3 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            ...
            <div className="flex justify-between text-xs text-pr-text-2 mt-1">
          ...
          {amount && parseFloat(amount) > 0 && (
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-4 border border-green-200">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="font-semibold text-pr-text-1">Projected Rewards</h3>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-sm text-pr-text-2">Daily Reward</div>
                  <div className="font-bold text-green-600">+{rewards.daily.toFixed(2)} Gems</div>
                </div>
                <div>
                  <div className="text-sm text-pr-text-2">Total Rewards</div>
                  <div className="font-bold text-green-600">+{rewards.total.toFixed(2)} Gems</div>
                </div>
                <div className="col-span-2">
                  <div className="text-sm text-pr-text-2">Final Amount</div>
            ...
            <button
              ...
              className={`flex-1 px-6 py-3 rounded-lg font-medium transition-all duration-200 ${
                canStake && !loading
                  ...
                  : 'bg-pr-surface-3 text-pr-text-2 cursor-not-allowed'
              }`}
            >
