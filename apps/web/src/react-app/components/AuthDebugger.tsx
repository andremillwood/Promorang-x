  ...
  return (
    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mt-6">
      ...
      <div className="space-y-4">
        ...
        {debugInfo && (
          <div className="bg-pr-surface-card rounded-lg p-4 border">
            <h4 className="font-semibold text-pr-text-1 mb-2">Debug Results:</h4>
            <pre className="text-xs text-pr-text-1 overflow-auto max-h-96 bg-pr-surface-2 p-3 rounded">
