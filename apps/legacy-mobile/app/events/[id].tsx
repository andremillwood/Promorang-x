...
export default function EventDetailScreen() {
    ...
    const handlePurchaseTicket = async (tierId: string) => {
        ...
        try {
            ...
            const result = await purchaseTicket(id!, tierId);
            if (result.success) {
                Alert.alert(
                    'Ticket Purchased!',
    ...
    const handleRsvp = async () => {
        ...
        try {
            ...
            const result = await rsvpToEvent(id!, currentEvent?.hasRsvp);
            if (result.success) {
                fetchEventById(id!); // Refresh to get updated attendee count
            } else {
    ...
    const handleShare = async () => {
        ...
        try {
            await Share.share({
                message: `Check out this event on Promorang: ${currentEvent.title}\n${currentEvent.description || ''}`,
