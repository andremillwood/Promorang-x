...
const CATEGORIES: Category[] = [
    ...
    { id: 'invest', name: 'Invest', icon: BarChart3, color: '#3B82F6', route: '/(tabs)/forecasts', description: 'Forecasts & analytics' },
    { id: 'growth', name: 'Growth', icon: Sparkles, color: '#10B981', route: '/(tabs)/growth', description: 'Stake & grow' },
    { id: 'leaderboard', name: 'Leaderboard', icon: BarChart3, color: '#EF4444', route: '/leaderboard', description: 'Top members' },
];
                    ...
                    >
                        <View style={styles.heroContent}>
                            <View>
                                ...
                                <Text style={styles.heroSubtitle}>Explore the Promorang universe</Text>
                            </View>
                            <Compass size={40} color="rgba(255,255,255,0.2)" />
                        </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.categoriesGrid}>
                        {CATEGORIES.filter(cat => {
                            ...
                            // Only show core hubs in focused mode
                            const focusedIds = ['events', 'scout', 'market', 'shop', 'deals', 'promoshare'];
                            return focusedIds.includes(cat.id);
                        }).map((category) => (
                            <TouchableOpacity
                                key={category.id}
