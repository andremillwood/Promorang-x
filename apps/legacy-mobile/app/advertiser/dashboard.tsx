...
export default function AdvertiserDashboardScreen() {
    ...
    const renderOverviewTab = () => (
        <View style={styles.content}>
            ...
            <View style={styles.actionSection}>
                ...
                <TouchableOpacity
                    style={styles.quickCampaignButton}
                    activeOpacity={0.9}
                    onPress={() => setShowQuickCampaign(true)}
                >
                    <Sparkles size={20} color="#10B981" />
                    <Text style={styles.quickCampaignText}>Quick Campaign</Text>
                </TouchableOpacity>
            </View>
    ...
    return (
        <View style={styles.container}>
            ...
            <QuickCampaignModal
                visible={showQuickCampaign}
                onClose={() => setShowQuickCampaign(false)}
                onSuccess={(campaignId) => {
                    setShowQuickCampaign(false);
                    router.push(`/advertiser/campaigns/${campaignId}` as any);
                }}
            />
        </View>
    );
