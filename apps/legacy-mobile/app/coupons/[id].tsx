...
import { useCouponStore, UserCoupon } from '@/store/couponStore';
...
export default function CouponDetailScreen() {
    ...
    const { getCoupon, redeemCoupon, isLoading } = useCouponStore();
    ...
    const handleRedeem = async () => {
        if (!id || !coupon || coupon.is_redeemed) return;
        ...
        Alert.alert(
            ...
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        setIsRedeeming(true);
                        const success = await redeemCoupon(id);
                        if (success) {
