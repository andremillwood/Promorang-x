...
interface AuthState {
  ...
  demoLogin: (type: 'creator' | 'investor' | 'advertiser' | 'operator' | 'merchant' | 'matrix' | 'samplingMerchant' | 'activeSampling' | 'graduatedMerchant' | 'state0' | 'state1' | 'state2' | 'state3') => Promise<void>;
...
export const useAuthStore = create<AuthState>()(
  persist(
    (set, get) => ({
      ...
      demoLogin: async (type: 'creator' | 'investor' | 'advertiser' | 'operator' | 'merchant' | 'matrix' | 'samplingMerchant' | 'activeSampling' | 'graduatedMerchant' | 'state0' | 'state1' | 'state2' | 'state3') => {
        set({ isLoading: true });
        try {
