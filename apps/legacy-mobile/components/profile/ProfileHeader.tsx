...
export const ProfileHeader: React.FC<ProfileHeaderProps> = ({
  ...
  const stats = [
    ...
    {
      label: 'Treasures',
      value: (user.gems_balance || 0).toLocaleString(),
      subValue: `≈ $${((user.gems_balance || 0) * 0.01).toFixed(2)}`,
      icon: Gem,
      color: '#8B5CF6',
          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                {stat.subValue && (
                  <Text style={[styles.statSubValue, { color: theme.textSecondary }]}>{stat.subValue}</Text>
                )}
              </View>
            );
          })}
