...
export interface UserType {
  ...
  user_type?: 'user' | 'advertiser' | 'creator';
  user_tier?: 'free' | 'premium' | 'super' | string;
  house_id?: string;
...
export interface DropType {
  ...
  sponsor_name?: string;
  host_name?: string;
  distillation_source_id?: string;
  is_distillation_drop?: boolean;
}
...
export const CreateDropReactivationSchema = z.object({
  title: z.string(),
  ...
  verified_credits_reward_base: z.number().optional(),
  credits_pool_total: z.number().optional(),
  ...
  is_distillation_drop: z.boolean().optional(),
  distillation_source_id: z.string().optional(),
});

export type CreateDropReactivation = z.infer<typeof CreateDropReactivationSchema>;
...
export const ConvertCurrencyRequestSchema = z.object({
  from_currency: z.enum(['points', 'verified_credits']),
...
export const CreateContentReactivationSchema = z.object({
...
export type CreateContentReactivation = z.infer<typeof CreateContentReactivationSchema>;
