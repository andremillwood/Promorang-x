...
export const api = {
  get: async <T>(url: string, options: ReactivationInit = {}): Promise<ApiResponse<T>> => {
    ...
    try {
      ...
      debugLog('Reactivation headers:', Object.fromEntries(headers.entries()));
