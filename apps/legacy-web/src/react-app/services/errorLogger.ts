...
export class ErrorLogger {
  ...
  private consoleLog(level: 'error' | 'warn' | 'info', message: string, data: unknown) {
...
export const ErrorCategory = ErrorCategories;

// Convenience functions for common error types
export const logAuthError = async (error: unknown, context: ErrorContext = {}) => {
...
export const logApiError = async (error: unknown, endpoint: string, context: ErrorContext = {}) => {
  await errorLogger.logError({
    error,
...
export const logUnexpectedError = async (
  error: unknown,
