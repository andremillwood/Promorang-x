...
import { X, Instagram, Copy, Check, TrendingUp } from 'lucide-react';
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-sm text-pr-text-2">
                Verify your Instagram account to earn your monthly **Credibility** score
              </p>
            </div>
            ...
            <div className="rounded-lg border border-pink-200 bg-gradient-to-r from-pink-50 to-purple-50 p-4">
              ...
              <div className="space-y-2 text-sm text-pink-700">
                <div className="flex items-center justify-between">
                  <span>Your Tier:</span>
                  <span className="font-semibold capitalize">{user.user_tier || 'free'}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Monthly Credibility:</span>
                  <span className="font-bold text-pink-600">{tierPoints} pts</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            <div className="mt-6 rounded-lg border border-blue-200 bg-gradient-to-r from-blue-50 to-cyan-50 p-4">
              ...
              <p className="mb-4 text-sm text-blue-700">
                Try our new **Influence Credibility** program! Earn dynamic monthly scores based on your actual follower count (followers × 0.01).
              </p>
              <div className="flex items-center justify-between text-sm">
                <div className="space-y-1 text-blue-600">
                  <div>• 5,000 followers = 50 pts/month</div>
                  <div>• 10,000 followers = 100 pts/month</div>
                  <div>• 50,000 followers = 500 pts/month</div>
                </div>
                <button
                  onClick={() => {
                    onClose();
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                {loading ? 'Verifying...' : 'Verify & Claim Credibility'}
              </button>
            ...
            <div className="mt-6 rounded-lg border border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50 p-4">
              ...
              <p className="mb-4 text-sm text-purple-700">
                Explore our **Influence Credibility** program for dynamic monthly scores based on your follower count.
              </p>
              <button
                onClick={() => {
                  onClose();
