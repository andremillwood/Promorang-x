...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen-dynamic bg-pr-surface-2 flex items-center justify-center px-4">
          <div className="max-w-md w-full bg-pr-surface-card rounded-xl shadow-lg p-8 text-center">
            <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <AlertTriangle className="w-8 h-8 text-red-600" />
            </div>
            
            <h1 className="text-2xl font-bold text-pr-text-1 mb-2">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-pr-surface-2 hover:bg-pr-surface-3 text-pr-text-1 px-4 py-2 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2"
              >
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <details className="mt-6 text-left">
                <summary className="cursor-pointer text-sm text-pr-text-2 hover:text-pr-text-1">
