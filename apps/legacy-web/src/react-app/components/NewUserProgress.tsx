    ...
    const fetchGoals = async () => {
        try {
            ...
            const mockGoals: Goal[] = [
                { id: 'profile', title: 'Complete Profile', description: 'Add a bio and avatar', completed: true, reward: '10 Verified Credits', action: '/profile' },
                { id: 'interest', title: 'Pick Interests', description: 'Select at least 3 categories', completed: true, reward: '5 Verified Credits', action: '/onboarding' },
                { id: 'drop', title: 'First Application', description: 'Apply for your first drop', completed: false, reward: '20 Verified Credits', action: '/marketplace' },
                { id: 'share', title: 'First Share', description: 'Share content from the feed', completed: false, reward: '15 Verified Credits', action: '/dashboard' },
                { id: 'streak', title: '3-Day Streak', description: 'Login 3 days in a row', completed: false, reward: '50 Verified Credits', action: '/dashboard' },
            ];
