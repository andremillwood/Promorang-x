      ...
      <div className="w-full max-w-md space-y-8 text-center">
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-pr-text-1">{title}</h2>
            {description && (
              <p className="text-pr-text-2">{description}</p>
            )}
          </div>
          
          <div className="w-full max-w-xs mx-auto pt-4">
            <div className="h-1.5 w-full bg-pr-surface-3 rounded-full overflow-hidden">
