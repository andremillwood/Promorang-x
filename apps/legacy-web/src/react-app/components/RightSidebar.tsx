      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-pr-surface-card rounded-xl border border-pr-border p-4">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="font-semibold text-pr-text-1">Earn More Verified Credits</h3>
          </div>
          <div className="space-y-3">
            {[
              { title: 'Review: Premium Bundle', reward: '120 verified_credits', urgency: 'Ending soon' },
              { title: 'Share: Launch Video', reward: '45 verified_credits', urgency: 'High yield' },
            ].map((item, idx) => (
              <Link
                key={idx}
                to="/earn"
