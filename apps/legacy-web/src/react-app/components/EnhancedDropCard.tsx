    ...
    >
        ...
        <div className="text-right">
          <div className="flex items-center space-x-1 text-purple-600 mb-1">
            ...
            <span className="text-sm font-semibold">
              {drop.gem_pool_remaining} verified_credits
            </span>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        ...
        <div className="text-center p-3 bg-pr-surface-2 rounded-lg">
          ...
          <div className="text-xs text-pr-text-2">verified_credits</div>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            {drop.status?.toLowerCase() === 'active' ? (
              <>
                <span>{drop.drop_role === 'BUY' ? 'Verify Purchase' : 'Apply Now'}</span>
