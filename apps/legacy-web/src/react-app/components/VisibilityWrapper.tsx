...
const FEATURE_VISIBILITY: Record<string, Record<UserMaturityState, VisibilityMode>> = {
  ...
  // PromoShare badge - always visible
  promoshare_badge: {
    [UserMaturityState.FIRST_TIME]: 'full',
    [UserMaturityState.ACTIVE]: 'full',
    [UserMaturityState.REWARDED]: 'full',
  ...
  // Social Shield badge - always visible
  social_shield_badge: {
    [UserMaturityState.FIRST_TIME]: 'full',
    [UserMaturityState.ACTIVE]: 'full',
    [UserMaturityState.REWARDED]: 'full',
  ...
  // Growth Hub - visible immediately
  growth_hub: {
    [UserMaturityState.FIRST_TIME]: 'full',
    [UserMaturityState.ACTIVE]: 'full',
    [UserMaturityState.REWARDED]: 'full',
  ...
  // Matrix/Referrals - visible immediately
  matrix: {
    [UserMaturityState.FIRST_TIME]: 'full',
    [UserMaturityState.ACTIVE]: 'full',
    [UserMaturityState.REWARDED]: 'full',
  ...
  // Operator tools - kept for operators only
  operator_tools: {
