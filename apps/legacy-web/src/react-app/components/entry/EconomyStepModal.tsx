...
const STEP_CONTENT = {
    ...
    withdraw: {
        ...
        subtitle: 'Verified Credits convert to cash you can spend anywhere',
        bullets: [
            { icon: '💎', text: '1 Gem = $1 USD, always' },
            { icon: '🏦', text: 'Withdraw to PayPal, Venmo, or bank account' },
            { icon: '🛍️', text: 'Or use verified_credits for in-app purchases and boosts' },
        ],
        incentive: 'No minimum withdrawal, no hidden fees',
        cta: { label: 'View Ledger', path: '/ledger' },
        ctaSecondary: { label: 'How to Earn Verified Credits', path: '/deals' },
    },
};
