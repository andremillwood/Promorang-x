...
const RANK_DATA = [
    ...
    },
    {
        ...
        unlocks: ['Leaderboard access', 'Activation draws', 'Referral rewards'],
    },
    {
        level: 3,
        name: 'Insider',
        ...
        unlocks: ['Activation Center', 'Priority opportunities', 'Full platform access'],
    },
];
            ...
            <details className="group">
                ...
                <div className="mt-3 space-y-2 pl-6 text-sm text-pr-text-2">
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <span>Unlock the daily rewards and activation draws</span>
                    </div>
                    <div className="flex items-start gap-2">
                        <TrendingUp className="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" />
                        <span>Access Activation Center to multiply your credits</span>
                    </div>
                    <div className="flex items-start gap-2">
