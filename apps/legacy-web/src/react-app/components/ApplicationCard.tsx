  ...
  return (
    <>
      <div className={`rounded-2xl p-6 border ${
        isDemo ? 'bg-orange-50 border-orange-200' : 'bg-pr-surface-2 border-pr-border'
      }`}>
        {/* Demo Banner */}
        {isDemo && (
          <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-lg px-3 py-2 mb-4 text-center">
            <div className="flex items-center justify-center space-x-2 text-sm font-medium">
              <span>🧪</span>
              <span>DEMO APPLICATION - No real verified_credits earned</span>
              <span>🧪</span>
            </div>
          </div>
        )}
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <div className="flex items-center space-x-2 mb-2">
              <h4 className="font-semibold text-pr-text-1">{(application as any).drop_title}</h4>
            ...
            <p className="text-pr-text-2 mb-3">{application.application_message}</p>
          ...
          <div className="text-right ml-6">
            <div className="text-sm text-pr-text-2 mb-1">
              {isDemo ? 'Demo Earned' : 'Earned'}
            </div>
            <div className={`font-semibold ${isDemo ? 'text-orange-600' : 'text-purple-600'}`}>
              {application.verified_credits_earned} verified_credits {isDemo && '(Demo)'}
            </div>
