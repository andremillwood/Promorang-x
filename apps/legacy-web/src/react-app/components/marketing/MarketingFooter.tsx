        ...
        <footer className="bg-pr-surface-1 border-t border-pr-border">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    {/* Success Standard */}
                    <div>
                        <h3 className="text-sm font-bold text-pr-text-1 mb-4 uppercase tracking-wider">Success Standard</h3>
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link to="/referral-program" className="text-sm text-pr-text-2 hover:text-pr-text-1 transition-colors">
                                    Growing the Circle
                                </Link>
                            </li>
                        </ul>
                    ...
                    {/* Business */}
                    <div>
                        <h3 className="text-sm font-bold text-pr-text-1 mb-4 uppercase tracking-wider">Business</h3>
                        <ul className="space-y-3">
                            <li>
                    ...
                    {/* Resources */}
                    <div>
                        <h3 className="text-sm font-bold text-pr-text-1 mb-4 uppercase tracking-wider">Resources</h3>
                        <ul className="space-y-3">
                            <li>
                                <Link to="/support" className="text-sm text-pr-text-2 hover:text-pr-text-1 transition-colors">
                                    Support
                                </Link>
                            </li>
                            <li>
                    ...
                    {/* Legal */}
                    <div>
                        <h3 className="text-sm font-bold text-pr-text-1 mb-4 uppercase tracking-wider">Legal</h3>
                        <ul className="space-y-3">
                            <li>
