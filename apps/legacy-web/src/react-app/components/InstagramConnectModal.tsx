            ...
            <div className="relative w-full max-w-md bg-pr-surface-card rounded-2xl shadow-2xl border border-pr-border overflow-hidden">
                ...
                <div className="p-5 space-y-5">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-pr-text-1">Activate Your Credibility</h3>
                            <p className="text-sm text-pr-text-2 mt-1">
                                Our bot will guide you through verifying your account and activating your Credibility score.
                            </p>
                        </div>
                    </div>
