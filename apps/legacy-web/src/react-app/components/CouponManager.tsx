  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-pr-text-1">Participation Outcomes</h2>
          <p className="text-sm text-pr-text-2">
            Incentivize participation by attaching rewards to drops or leaderboard milestones.
          </p>
        </div>
        <button
          onClick={() => {
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-xl border border-pr-surface-3 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-pr-text-2">Active Rewards</p>
      ...
      {showCreateForm && (
        ...
        >
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-pr-text-1">Create New Reward</h3>
            <button
              type="button"
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="credit">Credit (verified_credits/keys)</option>
              </select>
            </div>
          </div>
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="verified_credits">Verified Credits</option>
