                    ...
                    <div className="p-6 md:p-8">
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                            ...
                            <div className="flex gap-4">
                                ...
                                {(event.total_rewards_pool > 0 || event.total_verified_credits_pool > 0) && (
                                    <div className="text-center px-4 py-2 bg-green-500/10 rounded-xl border border-green-500/20">
                                        <p className="text-xl font-bold text-green-600">
                                            {event.total_rewards_pool > 0 ? event.total_rewards_pool : event.total_verified_credits_pool}
                                        </p>
                                        ...
                                        <div key={tier.id} className="p-4 bg-pr-surface-2 rounded-xl border border-pr-border hover:border-purple-300 transition-colors">
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <div className="text-right">
                                                    <p className="text-lg font-black text-purple-600">{tier.price_verified_credits} Outcome Credits</p>
