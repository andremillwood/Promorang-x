...
export default function PricingPage() {
    ...
    const plans = [
        {
            name: "Free",
            price: "$0",
            description: "Perfect for new creators getting started. Build habits and earn your first Verified Credits.",
            features: [
                "Access to public Drops",
                "Limited daily Move participation",
                "Earn Verified Credits via interactions",
                "Basic analytics",
                "Community support"
            ],
            constraints: "≈300 Verified Credits/month ceiling • No withdrawals",
            cta: "Get Started",
            highlight: false
        },
        {
    ...
    return (
        <div className="min-h-screen-dynamic bg-pr-surface-background">
            ...
            <CTASection
                headline="Still have activationions?"
