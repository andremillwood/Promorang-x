...
export default function ActivationsMarketingPage() {
    return (
        <div className="min-h-screen-dynamic bg-pr-surface-background">
            <SEO
                title="Activations - Reach Your Audience at Scale"
                description="Launch marketing activations that connect you with creators and engaged users. Set objectives, match with talent, and track ROI."
                keywords="marketing activations, creator activations, brand activations, promorang advertising"
                canonicalUrl="https://promorang.co/activations-marketing"
            />
            <MarketingNav />
            ...
            <section className="relative py-24 md:py-32 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center gap-2 bg-violet-500/20 border border-violet-500/30 px-4 py-2 rounded-full mb-8">
                        ...
                        <span className="text-sm font-bold text-violet-400">ACTIVATIONS</span>
                    </div>
                    <h1 className="text-5xl md:text-7xl font-extrabold text-pr-text-1 tracking-tight mb-6">
                        Activations That <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-purple-500">Perform</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-pr-text-2 max-w-3xl mx-auto mb-10">
                        Launch comprehensive marketing activations. Match with creators. <strong className="text-violet-400">Track every metric</strong>.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="/advertiser/activations/new" className="px-8 py-4 bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-lg font-semibold hover:opacity-90 transition-all shadow-xl flex items-center gap-2">
                            Launch an Activation <ArrowRight className="w-5 h-5" />
                        </a>
            ...
            <section className="py-24 bg-pr-surface-1 border-y border-pr-border">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl md:text-5xl font-bold text-pr-text-1 mb-16 text-center">
                        Activation <span className="text-violet-500">Types</span>
                    </h2>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            { step: '3', icon: Calendar, title: 'Run Activation', desc: 'Creators produce and share content' },
            ...
            <section className="py-24 bg-pr-surface-background">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-pr-text-2 mb-12">Track every aspect of your activation performance</p>
            ...
            <CTASection
                headline="Ready to launch your activation?"
                subheadline="Connect with creators and reach your audience at scale."
                ctaText="Start an Activation"
                ctaLink="/advertiser/activations/new"
