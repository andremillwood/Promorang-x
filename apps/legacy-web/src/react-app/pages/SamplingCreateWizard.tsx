    ...
    return (
        <div className="min-h-screen-dynamic bg-pr-surface-background">
            <div className="max-w-2xl mx-auto px-6 py-12">
                ...
                {/* Step Content */}
                <div className="bg-pr-surface-card rounded-2xl shadow-sm border border-pr-border p-8 mb-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {VALUE_TYPES.map(({ id, label, icon: Icon, description, color }) => (
                                    ...
                                    >
                                        ...
                                        <div className={`font-semibold ${formData.value_type === id ? 'text-gray-900' : 'text-pr-text-1'}`}>{label}</div>
                                        <div className={`text-xs ${formData.value_type === id ? 'text-gray-600' : 'text-pr-text-2'}`}>{description}</div>
                                    </button>
                                ))}
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-3">
                                    <input
                                        ...
                                        className="flex-1 px-4 py-3 bg-pr-input border border-pr-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-pr-text-1"
                                    ...
                                    <select
                                        ...
                                        className="px-4 py-3 bg-pr-input border border-pr-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-pr-text-1"
                                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-pr-input border border-pr-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-pr-text-1"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-4 py-3 bg-pr-input border border-pr-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent resize-none text-pr-text-1"
                            ...
                            <div className="space-y-3">
                                {SURFACES.map(({ id, label, description }) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            <div className={`font-semibold ${formData.surfaces.includes(id as Surface) ? 'text-gray-900' : 'text-pr-text-1'}`}>{label}</div>
                                            <div className={`text-xs ${formData.surfaces.includes(id as Surface) ? 'text-gray-600' : 'text-pr-text-2'}`}>{description}</div>
                                        </div>
                                    </button>
                                ))}
                            </div>
                            ...
                            <div className="bg-pr-surface-2 rounded-xl p-6 space-y-4">
                                <div className="flex items-center gap-3">
                                    <div className={`p-2 rounded-lg bg-${getValueTypeColor(formData.value_type)}-100`}>
                                        {formData.value_type === 'coupon' && <Percent className={`w-5 h-5 text-${getValueTypeColor(formData.value_type)}-600`} />}
                                        {formData.value_type === 'product' && <Package className={`w-5 h-5 text-${getValueTypeColor(formData.value_type)}-600`} />}
                                        {formData.value_type === 'voucher' && <Ticket className={`w-5 h-5 text-${getValueTypeColor(formData.value_type)}-600`} />}
                                        {formData.value_type === 'experience' && <Sparkles className={`w-5 h-5 text-${getValueTypeColor(formData.value_type)}-600`} />}
                                    </div>
                                    <div>
