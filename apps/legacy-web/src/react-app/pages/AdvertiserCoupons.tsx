...
type FormState = {
  ...
  value: number;
  value_unit: 'percentage' | 'fixed' | 'item' | 'usd' | 'verified_credits' | 'keys';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        <div>
          <h1 className="text-2xl font-bold text-pr-text-1">Coupons & Rewards</h1>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {coupons.map((coupon) => (
            <Link
              ...
              className="bg-pr-surface-card rounded-lg shadow-sm border border-pr-surface-3 p-6 hover:shadow-md transition-shadow"
            >
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-pr-text-2">Remaining</span>
                  <span className="font-medium text-pr-text-1">
