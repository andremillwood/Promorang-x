...
const PAGE_CATEGORIES: PageCategory[] = [
    {
        ...
        pages: [
            ...
            { path: '/moments', name: 'Open Moments', description: 'Participation discovery view' },
        ]
    },
    {
        name: 'Entry Surfaces',
    ...
    },
    {
        ...
        pages: [
            ...
            { path: '/ledger', name: 'Active Ledger', description: 'Verified execution history' },
    ...
    },
    {
        ...
        pages: [
            ...
            { path: '/admin/proofs', name: 'Mission Proofs', description: 'Proof moderation' },
            { path: '/admin/withdrawals', name: 'Withdrawals', description: 'Withdrawal management' },
