...
import ActivationsWidget from '@/react-app/components/ActivationsWidget';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        />
        <KPICard
          title="PromoOutcome Credits"
          value={(authUser?.verified_credits_balance || 0).toFixed(0)}
          change={8.3}
          changeType="increase"
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  { label: 'Shield Pool', value: '250 Outcome Credits', sublabel: 'Available' }
                ].map((stat) => (
        ...
        <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
          ...
          <EarningsChart
            data={dashboardData.map(d => ({
              date: d.date,
              earnings: d.earnings,
              verified_credits: d.earnings * 0.8,
              points: d.activity
            }))}
            height={300}
          />
      ...
      <div className="bg-pr-surface-card rounded-xl p-6 border border-pr-surface-3 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          ...
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            ...
            <p className="text-sm text-purple-600">Outcome Credits Earned</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-pr-surface-card rounded-xl p-6 shadow-sm border border-pr-surface-3">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => navigate('/ledger')} className="text-orange-600 hover:text-orange-700 text-sm font-medium">View All</button>
          </div>
          <div className="space-y-3">
