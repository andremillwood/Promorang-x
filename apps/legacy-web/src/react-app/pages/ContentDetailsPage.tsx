      ...
      <div className={cn("container mx-auto p-4 max-w-4xl", isModal && "p-0")}>
        ...
        <Card className="overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-pr-text-2">{formattedDate}</p>
                </div>
              </div>
          ...
          <CardContent className="pt-4">
            ...
            <div className="mb-4">
              <p className={cn("text-pr-text-1", !showMore && "line-clamp-3")}>
                {content.description}
              </p>
            ...
            {/* Media */}
            <div className="mb-4 rounded-lg overflow-hidden bg-pr-surface-2">
              {content.media_url ? (
                <img 
                ...
                <div className="aspect-video bg-pr-surface-3 flex items-center justify-center">
                  ...
                  <div className="space-y-4">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex space-x-3">
                        ...
                        <div className="flex-1">
                          <div className="bg-pr-surface-2 p-3 rounded-lg">
                            <div className="flex justify-between items-start">
                              <span className="font-medium">User {i}</span>
                              <span className="text-xs text-pr-text-2">2h ago</span>
                            </div>
                            <p className="mt-1 text-sm">
                              This is a sample comment {i}. Comments will be loaded here.
                            </p>
                          </div>
                          <div className="flex space-x-4 mt-1 text-xs text-pr-text-2">
                            <button className="hover:text-pr-text-1">Like</button>
                            <button className="hover:text-pr-text-1">Reply</button>
                          </div>
                        </div>
                      </div>
                    ))}
          ...
          <CardFooter className="bg-pr-surface-2 border-t px-6 py-4">
  ...
  return (
    <Card>
      <CardContent className="p-4">
        <p className="text-sm text-pr-text-2 mb-1">{title}</p>
