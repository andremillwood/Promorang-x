...
export default function BulkCouponCreation() {
  ...
  const exportTemplate = () => {
    const csv = [
      ...
      '100 Bonus Outcome Credits,Free verified_credits reward,credit,100,verified_credits,50,2025-01-01,2025-06-30',
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="verified_credits">Outcome Credits</option>
