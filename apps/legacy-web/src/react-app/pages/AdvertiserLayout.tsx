import { LayoutDashboard, Megaphone, Gift, FileCheck } from 'lucide-react';
...
export default function AdvertiserLayout() {
  ...
  const tabs = [
    ...
    { name: 'Activations', path: '/advertiser/activations', icon: Megaphone },
    { name: 'Reviews', path: '/advertiser/review', icon: FileCheck },
