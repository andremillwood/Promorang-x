...
import { PasswordResetReactivation } from '@/react-app/components/auth/PasswordResetReactivation';
...
export default function PasswordResetPage() {
  ...
  // Otherwise, show the password reset reactivation form
  return (
    <AuthLayout title="Forgot Password">
      <PasswordResetReactivation 
        email={email} 
