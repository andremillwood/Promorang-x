...
interface Deal {
  ...
  reward_type: 'verified_credits' | 'points' | 'coupon';
      ...
      <div className="px-4 py-3 bg-pr-surface-2/50 flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-sm text-pr-text-2">
            {deal.reward_type === 'verified_credits' ? 'Verified Credits' : deal.reward_type === 'points' ? 'Points' : 'Reward'}
          </span>
        </div>
        <button
          onClick={() => onClaim(deal.id)}
      ...
      try {
        ...
        if (couponsData.length > 0) {
          ...
          const apiDeals = couponsData.map((coupon: any) => ({
            ...
            reward_type: coupon.value_unit === '%' ? 'coupon' : 'verified_credits',
            ...
            <div className="flex flex-wrap gap-6 mt-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">Verified Credits Available</p>
                </div>
              </div>
            </div>
          </div>
