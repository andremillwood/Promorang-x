      ...
      <div className="px-4 py-3 bg-pr-surface-2/50 flex items-center justify-between">
        {event.reward_amount ? (
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-sm text-pr-text-2">Outcome Credits for attending</span>
          </div>
        ) : (
      ...
      try {
        ...
        if (apiEvents.length > 0) {
          const mappedEvents = apiEvents.map((evt: any) => ({
            ...
            reward_amount: evt.total_verified_credits_pool || evt.total_rewards_pool || evt.reward_verified_credits,
            ...
            <div className="flex flex-wrap gap-6 mt-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">Outcome Credits to Earn</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-emerald-700 mt-1">
                        ...
                        Earn <span className="font-semibold">bonus Outcome Credits</span> when attendees RSVP.
                      </p>
