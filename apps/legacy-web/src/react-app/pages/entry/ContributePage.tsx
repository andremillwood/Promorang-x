            ...
            try {
                ...
                if (data.status === 'success' && data.data?.summary) {
                    setReferralData({
                        ...
                        total_earnings: data.data.summary.total_earnings || { verified_credits: 0, points: 0 },
                    ...
                    {user && referralData && (
                        <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
                            ...
                            <div className="grid grid-cols-3 gap-3 mb-4">
                                ...
                                <div className="bg-white/10 rounded-lg p-3 text-center">
                                    <div className="text-2xl font-bold">{referralData.total_earnings.verified_credits}</div>
                                    <div className="text-xs opacity-80">Outcome Credits Earned</div>
                                </div>
                            </div>
